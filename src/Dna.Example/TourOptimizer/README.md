...
**1a. optimize\TourOptimizerExample.cs:** Basic example on how to call the JOpt TourOptimizer service

**1b. optimize\TourOptimizerDockerExample.cs:** Basic example on how to call a locally running JOpt TourOptimizer service from inside a docker container (e.g. our sandbox).
