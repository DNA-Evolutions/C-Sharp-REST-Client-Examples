...
{
    /// <summary>
    ///  Class for testing ElementConnectionType
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class ElementConnectionTypeTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for ElementConnectionType
        //private ElementConnectionType instance;

        public ElementConnectionTypeTests()
        {
            // TODO uncomment below to create an instance of ElementConnectionType
            //instance = new ElementConnectionType();
        }
        ...
        /// <summary>
        /// Test an instance of ElementConnectionType
        /// </summary>
        [Fact]
        public void ElementConnectionTypeInstanceTest()
        {
            // TODO uncomment below to test "IsType" ElementConnectionType
            //Assert.IsType<ElementConnectionType>(instance);
        }

        /// <summary>
        /// Test deserialize a EdgeElementConnection from type ElementConnectionType
        /// </summary>
        [Fact]
        public void EdgeElementConnectionDeserializeFromElementConnectionTypeTest()
        {
            // TODO uncomment below to test deserialize a EdgeElementConnection from type ElementConnectionType
            //Assert.IsType<ElementConnectionType>(JsonConvert.DeserializeObject<ElementConnectionType>(new EdgeElementConnection().ToJson()));
        }
