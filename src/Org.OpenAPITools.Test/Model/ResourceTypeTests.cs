...
namespace Org.OpenAPITools.Test.Model
{
    ...
    public class ResourceTypeTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a CapacityResource from type ResourceType
        /// </summary>
        [Fact]
        public void CapacityResourceDeserializeFromResourceTypeTest()
        {
            // TODO uncomment below to test deserialize a CapacityResource from type ResourceType
            //Assert.IsType<ResourceType>(JsonConvert.DeserializeObject<ResourceType>(new CapacityResource().ToJson()));
        }
