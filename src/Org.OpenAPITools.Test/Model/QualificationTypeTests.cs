...
namespace Org.OpenAPITools.Test.Model
{
    ...
    public class QualificationTypeTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a BitTypeQualification from type QualificationType
        /// </summary>
        [Fact]
        public void BitTypeQualificationDeserializeFromQualificationTypeTest()
        {
            // TODO uncomment below to test deserialize a BitTypeQualification from type QualificationType
            //Assert.IsType<QualificationType>(JsonConvert.DeserializeObject<QualificationType>(new BitTypeQualification().ToJson()));
        }

        /// <summary>
        /// Test deserialize a BitTypeWithExpertiseQualification from type QualificationType
        /// </summary>
        [Fact]
        public void BitTypeWithExpertiseQualificationDeserializeFromQualificationTypeTest()
        {
            // TODO uncomment below to test deserialize a BitTypeWithExpertiseQualification from type QualificationType
            //Assert.IsType<QualificationType>(JsonConvert.DeserializeObject<QualificationType>(new BitTypeWithExpertiseQualification().ToJson()));
        }
