...
namespace Org.OpenAPITools.Test.Api
{
    ...
    /// </remarks>
    public class OptimizationApiTests : IDisposable
    {
        private OptimizationApi instance;

        public OptimizationApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' OptimizationApi
            //Assert.IsType<OptimizationApi>(instance);
        }
        ...
        public void GetRunResultTest()
        {
            ...
            //string runId = null;
            //var response = instance.GetRunResult(runId);
        ...
        /// </summary>
        [Fact]
        public void GetRunSolutionTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.GetRunSolution(runId);
            //Assert.IsType<Solution>(response);
        }

        /// <summary>
        /// Test GetStartedSignal
        /// </summary>
        [Fact]
        public void GetStartedSignalTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.GetStartedSignal(runId);
        ...
        public void StartRunTest()
        {
            ...
            //var response = instance.StartRun(restOptimization);
            //Assert.IsType<RunAcceptedResponse>(response);
        }
        ...
        public void StopRunTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.StopRun(runId);
            //Assert.IsType<bool>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void StreamErrorsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.StreamErrors(runId);
        ...
        public void StreamProgressTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.StreamProgress(runId);
        ...
        public void StreamStatusTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.StreamStatus(runId);
        ...
        /// </summary>
        [Fact]
        public void StreamWarningsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string runId = null;
            //var response = instance.StreamWarnings(runId);
