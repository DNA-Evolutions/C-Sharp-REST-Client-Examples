...
{
    /// <summary>
    ///  Class for testing WriteDatabaseServiceControllerApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class WriteDatabaseServiceControllerApiTests : IDisposable
    {
        private WriteDatabaseServiceControllerApi instance;

        public WriteDatabaseServiceControllerApiTests()
        {
            instance = new WriteDatabaseServiceControllerApi();
        }
        ...
        /// <summary>
        /// Test an instance of WriteDatabaseServiceControllerApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' WriteDatabaseServiceControllerApi
            //Assert.IsType<WriteDatabaseServiceControllerApi>(instance);
        }

        /// <summary>
        /// Test SaveOptimization
        /// </summary>
        [Fact]
        public void SaveOptimizationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //RestOptimization restOptimization = null;
            //var response = instance.SaveOptimization(restOptimization);
