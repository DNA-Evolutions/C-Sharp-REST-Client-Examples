...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IOptimizationServiceControllerApiSync : IApiAccessor
    {
        ...
        ApiResponse<bool> RunStartedSginalWithHttpInfo();
        /// <summary>
    ...
    public interface IOptimizationServiceControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<bool> RunStartedSginalAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<bool>> RunStartedSginalWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Stream of status messages. During the optimization run you can obtain the optimization status by subscribing to this stream
        /// </summary>
        /// <remarks>
    ...
    public partial class OptimizationServiceControllerApi : IDisposable, IOptimizationServiceControllerApi
    {
        ...
        /// <summary>
        /// Emmits once an optimization started Emmits once an optimization started
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>bool</returns>
        public bool RunStartedSginal()
        {
            Org.OpenAPITools.Client.ApiResponse<bool> localVarResponse = RunStartedSginalWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of bool</returns>
        public Org.OpenAPITools.Client.ApiResponse<bool> RunStartedSginalWithHttpInfo()
        {
            Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = new Org.OpenAPITools.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<bool>("/api/optimize/startedSginal", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RunStartedSginal", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of bool</returns>
        public async System.Threading.Tasks.Task<bool> RunStartedSginalAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<bool> localVarResponse = await RunStartedSginalWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<bool>> RunStartedSginalWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<bool>("/api/optimize/startedSginal", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
