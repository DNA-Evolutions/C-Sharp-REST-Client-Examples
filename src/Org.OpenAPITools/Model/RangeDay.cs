...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RangeDay")]
    public partial class RangeDay : DateDef, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeDay" /> class.
        /// </summary>
        ...
        /// <param name="typeName">typeName (required) (default to &quot;RangeDay&quot;).</param>
        public RangeDay(Day from = default, Day to = default, string typeName = @"RangeDay") : base(typeName)
        {
            this.From = from;
            this.To = to;
        }
