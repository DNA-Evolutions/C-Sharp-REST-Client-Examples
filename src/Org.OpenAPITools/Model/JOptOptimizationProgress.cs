...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationProgress : IValidatableObject
    {
        ...
        public JOptOptimizationProgress(string id = default, string creator = default, string ident = default, string callerId = default, double curProgress = default, double curCost = default, int stage = default, string desc = default, DateTime expireAt = default)
        {
