...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationProgress : IEquatable<JOptOptimizationProgress>, IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "callerId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "curProgress", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "curCost", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as JOptOptimizationProgress);
        }

        /// <summary>
        /// Returns true if JOptOptimizationProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of JOptOptimizationProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JOptOptimizationProgress input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CurProgress == input.CurProgress ||
                    this.CurProgress.Equals(input.CurProgress)
                ) && 
                (
                    this.CurCost == input.CurCost ||
                    this.CurCost.Equals(input.CurCost)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CurProgress.GetHashCode();
                hashCode = (hashCode * 59) + this.CurCost.GetHashCode();
