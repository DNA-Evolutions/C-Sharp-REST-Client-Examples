...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ZoneNumberConstraint : ConstraintType, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ZoneNumberConstraint" /> class.
        /// </summary>
        /// <param name="zoneCodes">The list of numeric zone codes that a resource must be qualified for to visit this node. Used in conjunction with ZoneNumberQualification on the resource side. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;ZoneNumberConstraint&quot;).</param>
        public ZoneNumberConstraint(List<ZoneCodeType> zoneCodes = default, string typeName = @"ZoneNumberConstraint") : base()
        {
        ...
        /// <summary>
        /// The list of numeric zone codes that a resource must be qualified for to visit this node. Used in conjunction with ZoneNumberQualification on the resource side.
        /// </summary>
        /// <value>The list of numeric zone codes that a resource must be qualified for to visit this node. Used in conjunction with ZoneNumberQualification on the resource side.</value>
        ...
        /*
        <example>ZoneNumberConstraint</example>
        */
