...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptimizationPersistenceStrategySetting")]
    public partial class OptimizationPersistenceStrategySetting : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizationPersistenceStrategySetting" /> class.
        /// </summary>
        /// <param name="saveConnections">The saveConnections. Only takes action if saveOnlyResult is false..</param>
        public OptimizationPersistenceStrategySetting(bool saveConnections = default)
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptimizationPersistenceStrategySetting {\n");
