...
namespace Org.OpenAPITools.Model
{
    ...
    /// SupplyFlexLoadAllOf
    /// </summary>
    [DataContract(Name = "SupplyFlexLoad_allOf")]
    public partial class SupplyFlexLoadAllOf : IEquatable<SupplyFlexLoadAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplyFlexLoadAllOf" /> class.
        /// </summary>
        /// <param name="loadId">loadId.</param>
        /// <param name="isRequest">isRequest.</param>
        /// <param name="isFuzzyVisit">isFuzzyVisit.</param>
        /// <param name="typeName">The typeName of the object (default to &quot;SupplyFlexLoad&quot;).</param>
        public SupplyFlexLoadAllOf(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "SupplyFlexLoad")
        {
            this.LoadId = loadId;
            this.IsRequest = isRequest;
            this.IsFuzzyVisit = isFuzzyVisit;
            // use default value if no "typeName" provided
            this.TypeName = typeName ?? "SupplyFlexLoad";
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplyFlexLoadAllOf {\n");
        ...
        {
            return this.Equals(input as SupplyFlexLoadAllOf);
        }

        /// <summary>
        /// Returns true if SupplyFlexLoadAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SupplyFlexLoadAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupplyFlexLoadAllOf input)
        {
            if (input == null)
            {
                return false;
