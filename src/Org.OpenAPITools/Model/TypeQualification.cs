...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypeQualification")]
    public partial class TypeQualification : QualificationType, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeQualification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TypeQualification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeQualification" /> class.
        /// </summary>
        /// <param name="typeNames">A list of user-provided type-names. A Constraint type name must match to a Qualification type name to result in a violation free solution. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;Type&quot;).</param>
        public TypeQualification(List<string> typeNames = default, string typeName = @"Type") : base()
        {
            // to ensure "typeNames" is required (not null)
            if (typeNames == null)
            {
                throw new ArgumentNullException("typeNames is a required property for TypeQualification and cannot be null");
            }
            this.TypeNames = typeNames;
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for TypeQualification and cannot be null");
            }
            this.TypeName = typeName;
        }

        /// <summary>
        /// A list of user-provided type-names. A Constraint type name must match to a Qualification type name to result in a violation free solution.
        /// </summary>
        /// <value>A list of user-provided type-names. A Constraint type name must match to a Qualification type name to result in a violation free solution.</value>
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypeQualification {\n");
