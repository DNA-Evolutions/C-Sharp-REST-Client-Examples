...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UKPostCodeConstraint : ConstraintType, IEquatable<UKPostCodeConstraint>, IValidatableObject
    {
        /// <summary>
        ...
        public UKPostCodeConstraint(List<UKPostCode> zoneCodes = default(List<UKPostCode>), string typeName = "UKPostCodeConstraint") : base()
        {
        ...
        {
            return this.Equals(input as UKPostCodeConstraint);
        }

        /// <summary>
        /// Returns true if UKPostCodeConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of UKPostCodeConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UKPostCodeConstraint input)
        {
            if (input == null)
            {
                return false;
