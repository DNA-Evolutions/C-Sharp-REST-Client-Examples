...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UKPostCodeConstraint")]
    public partial class UKPostCodeConstraint : ConstraintType, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UKPostCodeConstraint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UKPostCodeConstraint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UKPostCodeConstraint" /> class.
        /// </summary>
        /// <param name="zoneCodes">The list of UK postcode zone codes that a resource must be qualified for to visit this node. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;UKPostCodeConstraint&quot;).</param>
        public UKPostCodeConstraint(List<ZoneCodeType> zoneCodes = default, string typeName = @"UKPostCodeConstraint") : base()
        {
            // to ensure "zoneCodes" is required (not null)
            if (zoneCodes == null)
            {
                throw new ArgumentNullException("zoneCodes is a required property for UKPostCodeConstraint and cannot be null");
            }
            this.ZoneCodes = zoneCodes;
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for UKPostCodeConstraint and cannot be null");
            }
            this.TypeName = typeName;
        }

        /// <summary>
        /// The list of UK postcode zone codes that a resource must be qualified for to visit this node.
        /// </summary>
        /// <value>The list of UK postcode zone codes that a resource must be qualified for to visit this node.</value>
        [DataMember(Name = "zoneCodes", IsRequired = true, EmitDefaultValue = true)]
        public List<ZoneCodeType> ZoneCodes { get; set; }
        ...
        /*
        <example>UKPostCodeConstraint</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UKPostCodeConstraint {\n");
