...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ConnectionByTime : IValidatableObject
    {
        ...
        public ConnectionByTime(List<AnyDefAllOfTimeDefs> timeDefinitions = default, List<long> timeMillis = default, List<double> distanceMeters = default)
        {
        ...
        public List<AnyDefAllOfTimeDefs> TimeDefinitions { get; set; }
