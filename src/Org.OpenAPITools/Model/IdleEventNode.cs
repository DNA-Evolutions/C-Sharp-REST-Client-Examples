...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IdleEventNode : NodeType, IValidatableObject
    {
        ...
        /// <param name="masterId">The id of the master node that triggered the creation of this idle event (e.g. in relation-based or return-to-start scenarios)..</param>
        /// <param name="relatedId">The id of the related node associated with this idle event (e.g. the node the resource is waiting for)..</param>
        /// <param name="creationTimeStamp">The epoch-millisecond timestamp when this idle event node was created by the optimizer..</param>
        ...
        /// <summary>
        /// The id of the master node that triggered the creation of this idle event (e.g. in relation-based or return-to-start scenarios).
        /// </summary>
        /// <value>The id of the master node that triggered the creation of this idle event (e.g. in relation-based or return-to-start scenarios).</value>
        [DataMember(Name = "masterId", EmitDefaultValue = false)]
        public string MasterId { get; set; }

        /// <summary>
        /// The id of the related node associated with this idle event (e.g. the node the resource is waiting for).
        /// </summary>
        /// <value>The id of the related node associated with this idle event (e.g. the node the resource is waiting for).</value>
        [DataMember(Name = "relatedId", EmitDefaultValue = false)]
        public string RelatedId { get; set; }

        /// <summary>
        /// The epoch-millisecond timestamp when this idle event node was created by the optimizer.
        /// </summary>
        /// <value>The epoch-millisecond timestamp when this idle event node was created by the optimizer.</value>
