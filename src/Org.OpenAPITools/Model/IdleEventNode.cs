...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IdleEventNode : NodeType, IValidatableObject
    {
        ...
        public IdleEventNode(PillarType pillarNode = default(PillarType), string masterId = default(string), string relatedId = default(string), long creationTimeStamp = default(long), string typeName = @"IdleEvent") : base()
        {
