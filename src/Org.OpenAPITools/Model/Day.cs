...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Day : DateDef, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Day" /> class.
        /// </summary>
        /// <param name="varDay">Day of the month..</param>
        /// <param name="typeName">typeName (required) (default to &quot;Day&quot;).</param>
        public Day(int varDay = default, string typeName = @"Day") : base(typeName)
        {
            this.VarDay = varDay;
        }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarDay: ").Append(VarDay).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        protected IEnumerable<ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            // VarDay (int) maximum
            if (this.VarDay > (int)31)
            {
                yield return new ValidationResult("Invalid value for VarDay, must be a value less than or equal to 31.", new [] { "VarDay" });
            }

            // VarDay (int) minimum
            if (this.VarDay < (int)1)
            {
                yield return new ValidationResult("Invalid value for VarDay, must be a value greater than or equal to 1.", new [] { "VarDay" });
            }
