...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptimizationPersistenceSetting")]
    public partial class OptimizationPersistenceSetting : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizationPersistenceSetting" /> class.
        /// </summary>
        /// <param name="mongoSettings">mongoSettings.</param>
        public OptimizationPersistenceSetting(MongoOptimizationPersistenceSetting mongoSettings = default)
        {
            this.MongoSettings = mongoSettings;
        }

        /// <summary>
        /// Gets or Sets MongoSettings
        /// </summary>
        [DataMember(Name = "mongoSettings", EmitDefaultValue = false)]
        public MongoOptimizationPersistenceSetting MongoSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptimizationPersistenceSetting {\n");
            sb.Append("  MongoSettings: ").Append(MongoSettings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
