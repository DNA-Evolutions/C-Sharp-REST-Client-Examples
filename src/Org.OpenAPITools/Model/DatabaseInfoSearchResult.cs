...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DatabaseInfoSearchResult : IValidatableObject
    {
        ...
        /// <param name="createdTimeStamp">The timestamp the snapshot was created.</param>
        ...
        public DatabaseInfoSearchResult(string creator = default, string ident = default, long createdTimeStamp = default, string type = default, string contentType = default, string id = default, SecurityHelperItemMetadata sec = default)
        {
