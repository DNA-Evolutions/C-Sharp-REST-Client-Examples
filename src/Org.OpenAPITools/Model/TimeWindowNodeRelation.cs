...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TimeWindowNodeRelation : NodeRelationType, IValidatableObject
    {
        ...
        public TimeWindowNodeRelation(string minTimeDeviation = default, string maxTimeDeviation = default, TimeComparisonJuncture timeComparisonJuncture = default, string typeName = @"TimeWindow") : base()
        {
