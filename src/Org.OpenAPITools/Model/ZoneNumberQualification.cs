...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ZoneNumberQualification : QualificationType, IValidatableObject
    {
        ...
        public ZoneNumberQualification(ZoneCodeType myCode = default(ZoneCodeType), List<ZoneCodeType> myExtraCodes = default(List<ZoneCodeType>), string typeName = @"ZoneNumberQualification") : base()
        {
