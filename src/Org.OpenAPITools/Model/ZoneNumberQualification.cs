...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ZoneNumberQualification : QualificationType, IEquatable<ZoneNumberQualification>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ZoneNumberQualification);
        }

        /// <summary>
        /// Returns true if ZoneNumberQualification instances are equal
        /// </summary>
        /// <param name="input">Instance of ZoneNumberQualification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZoneNumberQualification input)
        {
            if (input == null)
            {
                return false;
