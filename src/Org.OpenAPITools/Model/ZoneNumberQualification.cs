...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ZoneNumberQualification : QualificationType, IValidatableObject
    {
        ...
        /// <param name="myExtraCodes">Additional zone codes this resource is also qualified to serve, beyond the primary code..</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;ZoneNumberQualification&quot;).</param>
        public ZoneNumberQualification(ZoneCodeType myCode = default, List<ZoneCodeType> myExtraCodes = default, string typeName = @"ZoneNumberQualification") : base()
        {
        ...
        public ZoneCodeType MyCode { get; set; }

        /// <summary>
        /// Additional zone codes this resource is also qualified to serve, beyond the primary code.
        /// </summary>
        /// <value>Additional zone codes this resource is also qualified to serve, beyond the primary code.</value>
        [DataMember(Name = "myExtraCodes", EmitDefaultValue = false)]
        public List<ZoneCodeType> MyExtraCodes { get; set; }
