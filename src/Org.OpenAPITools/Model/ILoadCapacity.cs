...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoadCapacity : IEquatable<ILoadCapacity>, IValidatableObject
    {
        ...
        public ILoadCapacity(double currentLoad = default(double), double maximalIndividualLoadCapacity = default(double), long loadPickupTime = default(long), string id = default(string), string typeName = default(string))
        {
