...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoadCapacity : IValidatableObject
    {
        ...
        public ILoadCapacity(double currentLoad = default(double), long loadPickupTime = default(long), double maximalIndividualLoadCapacity = default(double), string id = default(string), string typeName = default(string))
        {
