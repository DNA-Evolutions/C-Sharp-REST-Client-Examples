...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoadCapacity : IValidatableObject
    {
        ...
        public ILoadCapacity(double maximalIndividualLoadCapacity = default, double currentLoad = default, long loadPickupTime = default, string id = default, string typeName = default)
        {
