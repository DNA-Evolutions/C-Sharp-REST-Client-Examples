...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoadCapacity : IValidatableObject
    {
        ...
        public ILoadCapacity(long loadPickupTime = default(long), double currentLoad = default(double), double maximalIndividualLoadCapacity = default(double), string id = default(string), string typeName = default(string))
        {
