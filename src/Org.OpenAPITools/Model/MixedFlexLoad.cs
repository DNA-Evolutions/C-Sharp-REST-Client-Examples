...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MixedFlexLoad : ILoad, IValidatableObject
    {
        ...
        public MixedFlexLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"MixedFlexLoad", int priority = default, bool fuzzyVisit = default, double loadValue = default, bool request = default, string id = default) : base(priority, fuzzyVisit, loadValue, request, id)
        {
