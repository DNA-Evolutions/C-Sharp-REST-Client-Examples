...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MixedFlexLoad : ILoad, IValidatableObject
    {
        ...
        public MixedFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = @"MixedFlexLoad", int priority = default(int), double loadValue = default(double), bool fuzzyVisit = default(bool), bool request = default(bool), string id = default(string)) : base(priority, loadValue, fuzzyVisit, request, id)
        {
