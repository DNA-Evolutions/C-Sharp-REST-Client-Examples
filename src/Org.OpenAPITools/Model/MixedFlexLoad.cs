...
namespace Org.OpenAPITools.Model
{
    ...
    /// MixedFlexLoad
    /// </summary>
    [DataContract(Name = "MixedFlexLoad")]
    public partial class MixedFlexLoad : ILoad, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MixedFlexLoad" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MixedFlexLoad() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MixedFlexLoad" /> class.
        /// </summary>
        ...
        /// <param name="typeName">The typeName of the object (required) (default to &quot;MixedFlexLoad&quot;).</param>
        /// <param name="priority">priority.</param>
        /// <param name="loadValue">loadValue.</param>
        /// <param name="request">request.</param>
        /// <param name="fuzzyVisit">fuzzyVisit.</param>
        /// <param name="id">id.</param>
        public MixedFlexLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"MixedFlexLoad", int priority = default, double loadValue = default, bool request = default, bool fuzzyVisit = default, string id = default) : base(priority, loadValue, request, fuzzyVisit, id)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for MixedFlexLoad and cannot be null");
            }
