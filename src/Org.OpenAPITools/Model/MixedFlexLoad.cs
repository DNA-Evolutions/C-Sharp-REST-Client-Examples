...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MixedFlexLoad : ILoad, IEquatable<MixedFlexLoad>, IValidatableObject
    {
        ...
        public MixedFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "MixedFlexLoad", int priority = default(int), bool fuzzyVisit = default(bool), double loadValue = default(double), bool request = default(bool), string id = default(string)) : base(priority, fuzzyVisit, loadValue, request, id)
        {
