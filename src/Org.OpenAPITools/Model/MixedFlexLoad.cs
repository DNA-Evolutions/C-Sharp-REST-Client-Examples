...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MixedFlexLoad : ILoad, IEquatable<MixedFlexLoad>, IValidatableObject
    {
        ...
        public MixedFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "MixedFlexLoad", int priority = default(int), bool fuzzyVisit = default(bool), bool request = default(bool), double loadValue = default(double), string id = default(string)) : base(priority, fuzzyVisit, request, loadValue, id)
        {
