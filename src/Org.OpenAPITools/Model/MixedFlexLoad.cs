...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MixedFlexLoad : ILoad, IEquatable<MixedFlexLoad>, IValidatableObject
    {
        /// <summary>
        ...
        public MixedFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "MixedFlexLoad", int priority = default(int), double loadValue = default(double), bool request = default(bool), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, loadValue, request, fuzzyVisit, id)
        {
        ...
        {
            return this.Equals(input as MixedFlexLoad);
        }

        /// <summary>
        /// Returns true if MixedFlexLoad instances are equal
        /// </summary>
        /// <param name="input">Instance of MixedFlexLoad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MixedFlexLoad input)
        {
            if (input == null)
            {
                return false;
