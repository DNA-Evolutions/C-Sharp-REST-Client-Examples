...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MongoOptimizationPersistenceSetting : IValidatableObject
    {
        ...
        public MongoOptimizationPersistenceSetting(bool enablePersistence = default, bool requireUniqueIdentCreatorCombination = default, string secret = default, string expiry = default, OptimizationPersistenceStratgySetting optimizationPersistenceStratgySetting = default, StreamPersistenceStratgySetting streamPersistenceStratgySetting = default)
        {
