...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoadCapacity : ILoadCapacity, IEquatable<SimpleLoadCapacity>, IValidatableObject
    {
        ...
        public SimpleLoadCapacity(string loadCapacityId = default(string), int maxCapacityValue = default(int), string typeName = "SimpleLoadCapacity", double maximalIndividualLoadCapacity = default(double), double currentLoad = default(double), long loadPickupTime = default(long), string id = default(string)) : base(maximalIndividualLoadCapacity, currentLoad, loadPickupTime, id)
        {
