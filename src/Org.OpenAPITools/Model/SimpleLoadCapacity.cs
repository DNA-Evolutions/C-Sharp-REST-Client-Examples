...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoadCapacity : ILoadCapacity, IValidatableObject
    {
        ...
        /// <param name="maxCapacityValue">The maximum individual load capacity of this depot entry..</param>
        ...
        public SimpleLoadCapacity(string loadCapacityId = default, int maxCapacityValue = default, string typeName = @"SimpleLoadCapacity", double maximalIndividualLoadCapacity = default, double currentLoad = default, long loadPickupTime = default, string id = default) : base(maximalIndividualLoadCapacity, currentLoad, loadPickupTime, id)
        {
        ...
        /// <summary>
        /// The maximum individual load capacity of this depot entry.
        /// </summary>
        /// <value>The maximum individual load capacity of this depot entry.</value>
        /*
        <example>100</example>
        */
