...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoadCapacity : ILoadCapacity, IValidatableObject
    {
        ...
        public SimpleLoadCapacity(string loadCapacityId = default(string), int maxCapacityValue = default(int), string typeName = @"SimpleLoadCapacity", long loadPickupTime = default(long), double currentLoad = default(double), double maximalIndividualLoadCapacity = default(double), string id = default(string)) : base(loadPickupTime, currentLoad, maximalIndividualLoadCapacity, id)
        {
