...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoadCapacity : ILoadCapacity, IValidatableObject
    {
        ...
        public SimpleLoadCapacity(string loadCapacityId = default(string), int maxCapacityValue = default(int), string typeName = @"SimpleLoadCapacity", double currentLoad = default(double), long loadPickupTime = default(long), double maximalIndividualLoadCapacity = default(double), string id = default(string)) : base(currentLoad, loadPickupTime, maximalIndividualLoadCapacity, id)
        {
