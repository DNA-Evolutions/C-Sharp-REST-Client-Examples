...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypeDictionaries")]
    public partial class TypeDictionaries : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeDictionaries" /> class.
        /// </summary>
        /// <param name="varTypeDictionaries">The optional list of typeDictionaries.</param>
        public TypeDictionaries(List<TypeDictionary> varTypeDictionaries = default)
        {
            this.VarTypeDictionaries = varTypeDictionaries;
        }

        /// <summary>
        /// The optional list of typeDictionaries
        /// </summary>
        /// <value>The optional list of typeDictionaries</value>
        [DataMember(Name = "typeDictionaries", EmitDefaultValue = false)]
        public List<TypeDictionary> VarTypeDictionaries { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypeDictionaries {\n");
            sb.Append("  VarTypeDictionaries: ").Append(VarTypeDictionaries).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
