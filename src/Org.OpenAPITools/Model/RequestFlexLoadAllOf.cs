...
{
    /// <summary>
    /// RequestFlexLoadAllOf
    /// </summary>
    [DataContract(Name = "RequestFlexLoad_allOf")]
    public partial class RequestFlexLoadAllOf : IEquatable<RequestFlexLoadAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestFlexLoadAllOf" /> class.
        /// </summary>
        /// <param name="loadId">loadId.</param>
        /// <param name="isRequest">isRequest.</param>
        /// <param name="isFuzzyVisit">isFuzzyVisit.</param>
        /// <param name="typeName">The typeName of the object (default to &quot;RequestFlexLoad&quot;).</param>
        public RequestFlexLoadAllOf(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "RequestFlexLoad")
        {
            this.LoadId = loadId;
            this.IsRequest = isRequest;
            this.IsFuzzyVisit = isFuzzyVisit;
            // use default value if no "typeName" provided
            this.TypeName = typeName ?? "RequestFlexLoad";
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestFlexLoadAllOf {\n");
        ...
        {
            return this.Equals(input as RequestFlexLoadAllOf);
        }

        /// <summary>
        /// Returns true if RequestFlexLoadAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestFlexLoadAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestFlexLoadAllOf input)
        {
            if (input == null)
            {
                return false;
