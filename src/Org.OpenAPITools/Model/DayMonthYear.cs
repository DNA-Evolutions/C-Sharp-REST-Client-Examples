...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DayMonthYear")]
    public partial class DayMonthYear : DateDef, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DayMonthYear" /> class.
        /// </summary>
        ...
        /// <param name="typeName">typeName (required) (default to &quot;DayMonthYear&quot;).</param>
        public DayMonthYear(int year = default, int month = default, int day = default, string typeName = @"DayMonthYear") : base(typeName)
        {
            this.Year = year;
            this.Month = month;
            this.Day = day;
        ...
        */
        ...
        /// </summary>
        /// <value>Month of the year (1–12).</value>
        /*
        <example>4</example>
        */
        ...
        /// </summary>
        /// <value>Day of the month (1–31).</value>
        /*
        <example>15</example>
        */
