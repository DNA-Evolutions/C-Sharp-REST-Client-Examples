...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationStatus : IValidatableObject
    {
        ...
        public JOptOptimizationStatus(string creator = default, string ident = default, string message = default, int code = default, string desc = default, DateTime expireAt = default, string id = default)
        {
