...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ZoneCodeType")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(UKPostCode), "UKPostCode")]
    [JsonSubtypes.KnownSubType(typeof(ZoneNumber), "ZoneNumber")]
    public partial class ZoneCodeType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZoneCodeType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ZoneCodeType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ZoneCodeType" /> class.
        /// </summary>
        /// <param name="typeName">typeName (required).</param>
        public ZoneCodeType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for ZoneCodeType and cannot be null");
            }
