...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JobAcceptedResponse")]
    public partial class JobAcceptedResponse : IValidatableObject
    {
        /// <summary>
        /// The status.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobAcceptedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JobAcceptedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JobAcceptedResponse" /> class.
        /// </summary>
        /// <param name="jobId">The unique job id token. This should be treated as secret but is not the only security barrier. (required).</param>
        /// <param name="creatorHash">Thr related creatorHash force-hashed by sha256(). In the optimization result the creator is only hashed, if the magic prefix &#39;hash:&#39; followed by the creator is used..</param>
        /// <param name="ident">The ident of the optimization to serach for. Leave blank if not required.</param>
        /// <param name="submittedAt">The time as millis when job was committed..</param>
        /// <param name="status">The status..</param>
        public JobAcceptedResponse(string jobId = default, string creatorHash = default, string ident = default, long submittedAt = default, StatusEnum? status = default)
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for JobAcceptedResponse and cannot be null");
            }
            this.JobId = jobId;
        ...
        /// <summary>
        /// The unique job id token. This should be treated as secret but is not the only security barrier.
        /// </summary>
        /// <value>The unique job id token. This should be treated as secret but is not the only security barrier.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// Thr related creatorHash force-hashed by sha256(). In the optimization result the creator is only hashed, if the magic prefix &#39;hash:&#39; followed by the creator is used.
        /// </summary>
        /// <value>Thr related creatorHash force-hashed by sha256(). In the optimization result the creator is only hashed, if the magic prefix &#39;hash:&#39; followed by the creator is used.</value>
        /*
        <example>025b6ba9c209f999e4900b78952263f6143bfee777567f104cf19413be902936</example>
        */
        [DataMember(Name = "creatorHash", EmitDefaultValue = false)]
        ...
        */
        ...
        /// <summary>
        /// The time as millis when job was committed.
        /// </summary>
        /// <value>The time as millis when job was committed.</value>
        /*
        <example>517464000</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobAcceptedResponse {\n");
            sb.Append("  JobId: ").Append(JobId).Append("\n");
            sb.Append("  CreatorHash: ").Append(CreatorHash).Append("\n");
