...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(CapacityResource), "Capacity")]
    public partial class ResourceType : IValidatableObject
    {
        ...
        public ResourceType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for ResourceType and cannot be null");
            }
