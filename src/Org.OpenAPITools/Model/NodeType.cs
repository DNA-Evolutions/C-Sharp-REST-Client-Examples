...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(EventNode), "EventNode")]
    [JsonSubtypes.KnownSubType(typeof(GeoNode), "Geo")]
    [JsonSubtypes.KnownSubType(typeof(GeoNode), "GeoNode")]
    [JsonSubtypes.KnownSubType(typeof(IdleEventNode), "IdleEvent")]
    [JsonSubtypes.KnownSubType(typeof(IdleEventNode), "IdleEventNode")]
    public partial class NodeType : IEquatable<NodeType>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as NodeType);
        }

        /// <summary>
        /// Returns true if NodeType instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeType input)
        {
            if (input == null)
            {
                return false;
