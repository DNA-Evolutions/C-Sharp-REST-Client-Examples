...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DifferentVisitorNodeRelation")]
    public partial class DifferentVisitorNodeRelation : NodeRelationType, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DifferentVisitorNodeRelation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DifferentVisitorNodeRelation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DifferentVisitorNodeRelation" /> class.
        /// </summary>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;DifferentVisitor&quot;).</param>
        public DifferentVisitorNodeRelation(string typeName = @"DifferentVisitor") : base()
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for DifferentVisitorNodeRelation and cannot be null");
            }
        ...
        /*
        <example>DifferentVisitor</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DifferentVisitorNodeRelation {\n");
