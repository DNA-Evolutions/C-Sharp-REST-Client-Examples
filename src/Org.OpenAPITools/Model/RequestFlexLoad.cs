...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestFlexLoad : ILoad, IEquatable<RequestFlexLoad>, IValidatableObject
    {
        ...
        public RequestFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "RequestFlexLoad", int priority = default(int), double loadValue = default(double), bool request = default(bool), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, loadValue, request, fuzzyVisit, id)
        {
