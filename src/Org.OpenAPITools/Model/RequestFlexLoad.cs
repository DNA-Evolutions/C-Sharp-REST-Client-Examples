...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestFlexLoad : ILoad, IValidatableObject
    {
        ...
        public RequestFlexLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"RequestFlexLoad", int priority = default, bool fuzzyVisit = default, double loadValue = default, bool request = default, string id = default) : base(priority, fuzzyVisit, loadValue, request, id)
        {
