...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestFlexLoad : ILoad, IValidatableObject
    {
        ...
        public RequestFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = @"RequestFlexLoad", int priority = default(int), bool request = default(bool), double loadValue = default(double), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, request, loadValue, fuzzyVisit, id)
        {
