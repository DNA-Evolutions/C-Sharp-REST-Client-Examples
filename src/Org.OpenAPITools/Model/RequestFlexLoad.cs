...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequestFlexLoad : ILoad, IValidatableObject
    {
        /// <summary>
        ...
        public RequestFlexLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"RequestFlexLoad", int priority = default, double loadValue = default, bool request = default, bool fuzzyVisit = default, string id = default) : base(priority, loadValue, request, fuzzyVisit, id)
        {
        ...
        /*
        <example>RequestFlexLoad</example>
        */
