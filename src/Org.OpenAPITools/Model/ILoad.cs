...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoad : IEquatable<ILoad>, IValidatableObject
    {
        ...
        public ILoad(int priority = default(int), bool fuzzyVisit = default(bool), double loadValue = default(double), bool request = default(bool), string id = default(string), string typeName = default(string))
        {
