...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoad : IEquatable<ILoad>, IValidatableObject
    {
        /// <summary>
        ...
        public ILoad(int priority = default(int), double loadValue = default(double), bool request = default(bool), bool fuzzyVisit = default(bool), string id = default(string), string typeName = default(string))
        {
        ...
        {
            return this.Equals(input as ILoad);
        }

        /// <summary>
        /// Returns true if ILoad instances are equal
        /// </summary>
        /// <param name="input">Instance of ILoad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ILoad input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LoadValue == input.LoadValue ||
                    this.LoadValue.Equals(input.LoadValue)
                ) && 
                (
                ...
                (
                    this.FuzzyVisit == input.FuzzyVisit ||
                    this.FuzzyVisit.Equals(input.FuzzyVisit)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LoadValue.GetHashCode();
                hashCode = (hashCode * 59) + this.Request.GetHashCode();
                hashCode = (hashCode * 59) + this.FuzzyVisit.GetHashCode();
                if (this.Id != null)
                {
