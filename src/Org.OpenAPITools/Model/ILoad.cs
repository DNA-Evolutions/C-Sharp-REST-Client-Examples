...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoad : IEquatable<ILoad>, IValidatableObject
    {
        ...
        public ILoad(int priority = default(int), bool fuzzyVisit = default(bool), bool request = default(bool), double loadValue = default(double), string id = default(string), string typeName = default(string))
        {
