...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ILoad : IValidatableObject
    {
        ...
        public ILoad(int priority = default(int), bool request = default(bool), double loadValue = default(double), bool fuzzyVisit = default(bool), string id = default(string), string typeName = default(string))
        {
