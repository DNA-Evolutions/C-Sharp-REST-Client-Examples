...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ZoneNumber : ZoneCodeType, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ZoneNumber" /> class.
        /// </summary>
        /// <param name="varZoneNumber">The numeric zone identifier assigned to this element. Zone numbers are used to define geographic territories for resources and to penalize or restrict zone crossings between nodes via ZoneConnections. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;ZoneNumber&quot;).</param>
        public ZoneNumber(int varZoneNumber = default, string typeName = @"ZoneNumber") : base()
        {
            this.VarZoneNumber = varZoneNumber;
        ...
        /// <summary>
        /// The numeric zone identifier assigned to this element. Zone numbers are used to define geographic territories for resources and to penalize or restrict zone crossings between nodes via ZoneConnections.
        /// </summary>
        /// <value>The numeric zone identifier assigned to this element. Zone numbers are used to define geographic territories for resources and to penalize or restrict zone crossings between nodes via ZoneConnections.</value>
        [DataMember(Name = "zoneNumber", IsRequired = true, EmitDefaultValue = true)]
        public int VarZoneNumber { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarZoneNumber: ").Append(VarZoneNumber).Append("\n");
