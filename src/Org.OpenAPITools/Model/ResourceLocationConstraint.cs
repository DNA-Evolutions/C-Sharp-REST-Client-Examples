...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResourceLocationConstraint : ConstraintType, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ResourceLocationConstraint" /> class.
        /// </summary>
        /// <param name="maxRadiusDistance">The maximum Euclidean or road-network distance a resource may be located from this node in order to be eligible to visit it. If omitted, only maxRadiusTime is enforced..</param>
        /// <param name="maxRadiusTime">The maximum travel time a resource may need to reach this node in order to be eligible to visit it. If omitted, only maxRadiusDistance is enforced..</param>
        ...
        /// <summary>
        /// The maximum Euclidean or road-network distance a resource may be located from this node in order to be eligible to visit it. If omitted, only maxRadiusTime is enforced.
        /// </summary>
        /// <value>The maximum Euclidean or road-network distance a resource may be located from this node in order to be eligible to visit it. If omitted, only maxRadiusTime is enforced.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// The maximum travel time a resource may need to reach this node in order to be eligible to visit it. If omitted, only maxRadiusDistance is enforced.
        /// </summary>
        /// <value>The maximum travel time a resource may need to reach this node in order to be eligible to visit it. If omitted, only maxRadiusDistance is enforced.</value>
        /*
