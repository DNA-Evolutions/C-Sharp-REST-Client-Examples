...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoad : ILoad, IEquatable<SimpleLoad>, IValidatableObject
    {
        /// <summary>
        ...
        public SimpleLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "SimpleLoad", int priority = default(int), bool fuzzyVisit = default(bool), bool request = default(bool), double loadValue = default(double), string id = default(string)) : base(priority, fuzzyVisit, request, loadValue, id)
        {
        ...
        {
            return this.Equals(input as SimpleLoad);
        }

        /// <summary>
        /// Returns true if SimpleLoad instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleLoad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleLoad input)
        {
            if (input == null)
            {
                return false;
