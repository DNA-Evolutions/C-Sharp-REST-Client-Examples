...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoad : ILoad, IValidatableObject
    {
        ...
        public SimpleLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"SimpleLoad", int priority = default, double loadValue = default, bool request = default, bool fuzzyVisit = default, string id = default) : base(priority, loadValue, request, fuzzyVisit, id)
        {
