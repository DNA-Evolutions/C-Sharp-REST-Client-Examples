...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoad : ILoad, IEquatable<SimpleLoad>, IValidatableObject
    {
        ...
        public SimpleLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "SimpleLoad", int priority = default(int), double loadValue = default(double), bool request = default(bool), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, loadValue, request, fuzzyVisit, id)
        {
