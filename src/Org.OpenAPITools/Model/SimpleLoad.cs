...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleLoad : ILoad, IValidatableObject
    {
        ...
        public SimpleLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = @"SimpleLoad", int priority = default(int), double loadValue = default(double), bool fuzzyVisit = default(bool), bool request = default(bool), string id = default(string)) : base(priority, loadValue, fuzzyVisit, request, id)
        {
