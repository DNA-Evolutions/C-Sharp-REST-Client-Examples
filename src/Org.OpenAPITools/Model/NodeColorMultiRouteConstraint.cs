...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NodeColorMultiRouteConstraint : ConstraintType, IValidatableObject
    {
        ...
        /// <param name="nodeColorCapacities">The per-color capacity limits (ratio-based) enforced by this multi-route constraint. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;NodeColorMultiRouteConstraint&quot;).</param>
        public NodeColorMultiRouteConstraint(IntegerMultiConstraintHelperItem mirrorItem = default, List<NodeColorCapacity> nodeColorCapacities = default, string typeName = @"NodeColorMultiRouteConstraint") : base()
        {
        ...
        /// <summary>
        /// The per-color capacity limits (ratio-based) enforced by this multi-route constraint.
        /// </summary>
        /// <value>The per-color capacity limits (ratio-based) enforced by this multi-route constraint.</value>
