...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AbsoluteNodeColorCapacity : IValidatableObject
    {
        ...
        /// <param name="minUsage">The minimum number of nodes of this color that must appear on a route for the constraint to be satisfied. (required).</param>
        /// <param name="maxUsage">The maximum number of nodes of this color permitted on a single route. (required).</param>
        public AbsoluteNodeColorCapacity(NodeColor nodeColor = default, int minUsage = default, int maxUsage = default)
        {
        ...
        /// <summary>
        /// The minimum number of nodes of this color that must appear on a route for the constraint to be satisfied.
        /// </summary>
        /// <value>The minimum number of nodes of this color that must appear on a route for the constraint to be satisfied.</value>
        [DataMember(Name = "minUsage", IsRequired = true, EmitDefaultValue = true)]
        public int MinUsage { get; set; }

        /// <summary>
        /// The maximum number of nodes of this color permitted on a single route.
        /// </summary>
        /// <value>The maximum number of nodes of this color permitted on a single route.</value>
