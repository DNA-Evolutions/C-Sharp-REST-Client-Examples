...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RangeWeekDay")]
    public partial class RangeWeekDay : DateDef, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeWeekDay" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RangeWeekDay() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeWeekDay" /> class.
        /// </summary>
        /// <param name="from">from.</param>
        /// <param name="to">to.</param>
        /// <param name="typeName">typeName (required) (default to &quot;RangeWeekDay&quot;).</param>
        public RangeWeekDay(WeekDay from = default, WeekDay to = default, string typeName = @"RangeWeekDay") : base(typeName)
        {
            this.From = from;
            this.To = to;
        }
