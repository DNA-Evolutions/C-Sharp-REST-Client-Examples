...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ConnectionRelatedLateMargin : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ConnectionRelatedLateMargin" /> class.
        /// </summary>
        /// <param name="shiftElementConnectionRealtedLateMargin">If true, the optimizer shifts the element&#39;s effective time window by the computed late margin, rather than simply absorbing the lateness as a soft violation. Produces a cleaner schedule representation..</param>
        /// <param name="applyPartialConnectionRelatedLateMargin">If true, partial late margins are applied proportionally based on the actual connection time relative to the maximum margin. If false, the full margin is applied as a binary threshold..</param>
        /// <param name="maxMargin">The maximum late-arrival margin that can be granted, regardless of how long the inbound connection is. Caps the proportional margin to prevent excessively permissive lateness tolerance. (required).</param>
        /// <param name="marginFactor">A factor between 0.0 and 1.0 that determines what proportion of the inbound connection time is granted as late-arrival margin. For example, a factor of 0.2 on a 50-minute connection yields a 10-minute margin (capped by maxMargin). (required).</param>
        public ConnectionRelatedLateMargin(bool shiftElementConnectionRealtedLateMargin = default, bool applyPartialConnectionRelatedLateMargin = default, string maxMargin = default, double marginFactor = default)
        {
        ...
        /// <summary>
        /// If true, the optimizer shifts the element&#39;s effective time window by the computed late margin, rather than simply absorbing the lateness as a soft violation. Produces a cleaner schedule representation.
        /// </summary>
        /// <value>If true, the optimizer shifts the element&#39;s effective time window by the computed late margin, rather than simply absorbing the lateness as a soft violation. Produces a cleaner schedule representation.</value>
        ...
        /// <summary>
        /// If true, partial late margins are applied proportionally based on the actual connection time relative to the maximum margin. If false, the full margin is applied as a binary threshold.
        /// </summary>
        /// <value>If true, partial late margins are applied proportionally based on the actual connection time relative to the maximum margin. If false, the full margin is applied as a binary threshold.</value>
        ...
        /// <summary>
        /// The maximum late-arrival margin that can be granted, regardless of how long the inbound connection is. Caps the proportional margin to prevent excessively permissive lateness tolerance.
        /// </summary>
        /// <value>The maximum late-arrival margin that can be granted, regardless of how long the inbound connection is. Caps the proportional margin to prevent excessively permissive lateness tolerance.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// A factor between 0.0 and 1.0 that determines what proportion of the inbound connection time is granted as late-arrival margin. For example, a factor of 0.2 on a 50-minute connection yields a 10-minute margin (capped by maxMargin).
        /// </summary>
        /// <value>A factor between 0.0 and 1.0 that determines what proportion of the inbound connection time is granted as late-arrival margin. For example, a factor of 0.2 on a 50-minute connection yields a 10-minute margin (capped by maxMargin).</value>
        /*
        <example>0.2</example>
        */
