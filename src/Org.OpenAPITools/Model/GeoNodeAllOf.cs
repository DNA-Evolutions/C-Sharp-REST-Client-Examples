...
namespace Org.OpenAPITools.Model
{
    ...
    /// GeoNodeAllOf
    /// </summary>
    [DataContract(Name = "GeoNode_allOf")]
    public partial class GeoNodeAllOf : IEquatable<GeoNodeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeoNodeAllOf" /> class.
        /// </summary>
        /// <param name="position">position.</param>
        /// <param name="pillarNode">pillarNode.</param>
        /// <param name="typeName">The typeName of the object (default to &quot;Geo&quot;).</param>
        public GeoNodeAllOf(Position position = default(Position), GeoPillarNode pillarNode = default(GeoPillarNode), string typeName = "Geo")
        {
            this.Position = position;
            this.PillarNode = pillarNode;
            // use default value if no "typeName" provided
            this.TypeName = typeName ?? "Geo";
        }
        ...
        {
            return this.Equals(input as GeoNodeAllOf);
        }

        /// <summary>
        /// Returns true if GeoNodeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GeoNodeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeoNodeAllOf input)
        {
            if (input == null)
            {
                return false;
