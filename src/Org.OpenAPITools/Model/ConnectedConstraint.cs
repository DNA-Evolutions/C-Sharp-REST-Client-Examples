...
namespace Org.OpenAPITools.Model
{
    ...
    {
        /// <summary>
        /// The logical operator connecting constraintOne and constraintTwo. Defines whether both must be satisfied (AND) or at least one (OR).
        /// </summary>
        /// <value>The logical operator connecting constraintOne and constraintTwo. Defines whether both must be satisfied (AND) or at least one (OR).</value>
        ...
        /// <param name="connectionType">The logical operator connecting constraintOne and constraintTwo. Defines whether both must be satisfied (AND) or at least one (OR). (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;ConnectedConstraint&quot;).</param>
        public ConnectedConstraint(Constraint constraintOne = default, Constraint constraintTwo = default, ConnectionTypeEnum connectionType = default, string typeName = @"ConnectedConstraint") : base()
        {
