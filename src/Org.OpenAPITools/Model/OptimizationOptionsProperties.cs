...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptimizationOptions_properties")]
    public partial class OptimizationOptionsProperties : Dictionary<String, string>, IEquatable<OptimizationOptionsProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizationOptionsProperties" /> class.
        /// </summary>
        /// <param name="empty">empty.</param>
        public OptimizationOptionsProperties(bool empty = default(bool)) : base()
        {
            this.Empty = empty;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptimizationOptionsProperties {\n");
        ...
        {
            return this.Equals(input as OptimizationOptionsProperties);
        }

        /// <summary>
        /// Returns true if OptimizationOptionsProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizationOptionsProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizationOptionsProperties input)
        {
            if (input == null)
            {
                return false;
