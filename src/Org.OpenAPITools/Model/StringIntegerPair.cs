...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StringIntegerPair : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="StringIntegerPair" /> class.
        /// </summary>
        /// <param name="left">A string key, typically a node or element identifier. (required).</param>
        /// <param name="right">An integer value associated with the key (e.g. a count, index, or capacity value). (required).</param>
        public StringIntegerPair(string left = default, int right = default)
        {
        ...
        /// <summary>
        /// A string key, typically a node or element identifier.
        /// </summary>
        /// <value>A string key, typically a node or element identifier.</value>
        [DataMember(Name = "left", IsRequired = true, EmitDefaultValue = true)]
        public string Left { get; set; }

        /// <summary>
        /// An integer value associated with the key (e.g. a count, index, or capacity value).
        /// </summary>
        /// <value>An integer value associated with the key (e.g. a count, index, or capacity value).</value>
