...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AnyDef : DateDef, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="AnyDef" /> class.
        /// </summary>
        /// <param name="timeDefs">List of date predicates evaluated with OR logic. The containing AnyDef matches if at least one entry matches..</param>
        ...
        /// <summary>
        /// List of date predicates evaluated with OR logic. The containing AnyDef matches if at least one entry matches.
        /// </summary>
        /// <value>List of date predicates evaluated with OR logic. The containing AnyDef matches if at least one entry matches.</value>
