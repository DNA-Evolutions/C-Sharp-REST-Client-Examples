...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RouteElementDetail : IEquatable<RouteElementDetail>, IValidatableObject
    {
        /// <summary>
        /// The scheduleStatus.
        /// </summary>
        ...
        [DataMember(Name = "elementId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "transitionTime", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "durationTime", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "transitionDistance", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as RouteElementDetail);
        }

        /// <summary>
        /// Returns true if RouteElementDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of RouteElementDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RouteElementDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.TransitionTime.Equals(input.TransitionTime))
                ) && 
                (
                    this.EffectivePosition == input.EffectivePosition ||
                    (this.EffectivePosition != null &&
                    this.EffectivePosition.Equals(input.EffectivePosition))
                ) && 
                (
                ...
                (
                    this.WhiteSpaceIdleTime == input.WhiteSpaceIdleTime ||
                    (this.WhiteSpaceIdleTime != null &&
                    this.WhiteSpaceIdleTime.Equals(input.WhiteSpaceIdleTime))
                ) && 
                (
                ...
                (
                    this.TransitionDistance == input.TransitionDistance ||
                    (this.TransitionDistance != null &&
                    this.TransitionDistance.Equals(input.TransitionDistance))
                ) && 
                (
                    this.ChoosenWorkingHoursIndex == input.ChoosenWorkingHoursIndex ||
                    this.ChoosenWorkingHoursIndex.Equals(input.ChoosenWorkingHoursIndex)
                ) && 
                (
                    this.EarlyDeviation == input.EarlyDeviation ||
                    (this.EarlyDeviation != null &&
                    this.EarlyDeviation.Equals(input.EarlyDeviation))
                ) && 
                (
                    this.LateDeviation == input.LateDeviation ||
                    (this.LateDeviation != null &&
                    this.LateDeviation.Equals(input.LateDeviation))
                ) && 
                (
                ...
                (
                    this.LoadChange == input.LoadChange ||
                    this.LoadChange != null &&
                    input.LoadChange != null &&
                    this.LoadChange.SequenceEqual(input.LoadChange)
                ) && 
                (
                    this.CurCapacity == input.CurCapacity ||
                    this.CurCapacity != null &&
                    input.CurCapacity != null &&
                    this.CurCapacity.SequenceEqual(input.CurCapacity)
                ) && 
                (
                    this.BeforeVisitNodeDepot == input.BeforeVisitNodeDepot ||
                    (this.BeforeVisitNodeDepot != null &&
                    this.BeforeVisitNodeDepot.Equals(input.BeforeVisitNodeDepot))
                ) && 
                (
                    this.AfterVisitNodeDepot == input.AfterVisitNodeDepot ||
                    (this.AfterVisitNodeDepot != null &&
                    this.AfterVisitNodeDepot.Equals(input.AfterVisitNodeDepot))
                ) && 
                (
                    this.NodeViolations == input.NodeViolations ||
                    this.NodeViolations != null &&
                    input.NodeViolations != null &&
                    this.NodeViolations.SequenceEqual(input.NodeViolations)
                ) && 
                (
                    this.IsUnlocatedIdleTime == input.IsUnlocatedIdleTime ||
                    this.IsUnlocatedIdleTime.Equals(input.IsUnlocatedIdleTime)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TransitionTime.GetHashCode();
                }
                if (this.EffectivePosition != null)
                {
                    hashCode = (hashCode * 59) + this.EffectivePosition.GetHashCode();
                }
                if (this.IdleTime != null)
                {
                    hashCode = (hashCode * 59) + this.IdleTime.GetHashCode();
                }
                if (this.WhiteSpaceIdleTime != null)
                {
                    hashCode = (hashCode * 59) + this.WhiteSpaceIdleTime.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.TransitionDistance.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.ChoosenWorkingHoursIndex.GetHashCode();
                if (this.EarlyDeviation != null)
                {
                    hashCode = (hashCode * 59) + this.EarlyDeviation.GetHashCode();
                }
                if (this.LateDeviation != null)
                {
                    hashCode = (hashCode * 59) + this.LateDeviation.GetHashCode();
                }
                ...
                if (this.LoadChange != null)
                {
                    hashCode = (hashCode * 59) + this.LoadChange.GetHashCode();
                }
                if (this.CurCapacity != null)
                {
                    hashCode = (hashCode * 59) + this.CurCapacity.GetHashCode();
                }
                if (this.BeforeVisitNodeDepot != null)
                {
                    hashCode = (hashCode * 59) + this.BeforeVisitNodeDepot.GetHashCode();
                }
                if (this.AfterVisitNodeDepot != null)
                {
                    hashCode = (hashCode * 59) + this.AfterVisitNodeDepot.GetHashCode();
                }
                if (this.NodeViolations != null)
                {
                    hashCode = (hashCode * 59) + this.NodeViolations.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.IsUnlocatedIdleTime.GetHashCode();
                return hashCode;
            }
        }
