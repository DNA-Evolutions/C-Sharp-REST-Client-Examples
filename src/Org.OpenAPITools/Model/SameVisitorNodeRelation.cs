...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SameVisitorNodeRelation")]
    public partial class SameVisitorNodeRelation : NodeRelationType, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SameVisitorNodeRelation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SameVisitorNodeRelation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SameVisitorNodeRelation" /> class.
        /// </summary>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;SameVisitor&quot;).</param>
        public SameVisitorNodeRelation(string typeName = @"SameVisitor") : base()
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for SameVisitorNodeRelation and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SameVisitorNodeRelation {\n");
