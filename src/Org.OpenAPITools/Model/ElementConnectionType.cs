...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ElementConnectionType")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(EdgeElementConnection), "Edge")]
    public partial class ElementConnectionType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementConnectionType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ElementConnectionType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementConnectionType" /> class.
        /// </summary>
        /// <param name="typeName">typeName (required).</param>
        public ElementConnectionType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for ElementConnectionType and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElementConnectionType {\n");
