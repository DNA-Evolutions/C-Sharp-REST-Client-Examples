...
namespace Org.OpenAPITools.Model
{
    ...
    /// The creatorSetting
    /// </summary>
    [DataContract(Name = "CreatorSetting")]
    public partial class CreatorSetting : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatorSetting" /> class.
        /// </summary>
        /// <param name="creator">The creator.</param>
        public CreatorSetting(string creator = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatorSetting {\n");
