...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AbsoluteNodeColorMultiRouteConstraint : ConstraintType, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="absoluteNodeColorCapacities">The per-color capacity limits (absolute count-based) enforced by this multi-route constraint. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;AbsoluteNodeColorMultiRouteConstraint&quot;).</param>
        public AbsoluteNodeColorMultiRouteConstraint(IntegerMultiConstraintHelperItem mirrorItem = default, List<AbsoluteNodeColorCapacity> absoluteNodeColorCapacities = default, string typeName = @"AbsoluteNodeColorMultiRouteConstraint") : base()
        {
        ...
        /// </summary>
        /// <value>The per-color capacity limits (absolute count-based) enforced by this multi-route constraint.</value>
        [DataMember(Name = "absoluteNodeColorCapacities", IsRequired = true, EmitDefaultValue = true)]
        ...
        /*
        <example>AbsoluteNodeColorMultiRouteConstraint</example>
        */
