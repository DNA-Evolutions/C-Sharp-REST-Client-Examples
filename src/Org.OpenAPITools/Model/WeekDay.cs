...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WeekDay : DateDef, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="WeekDay" /> class.
        /// </summary>
        /// <param name="day">ISO-8601 day of the week (1 &#x3D; Monday, 7 &#x3D; Sunday)..</param>
        /// <param name="typeName">typeName (required) (default to &quot;WeekDay&quot;).</param>
        public WeekDay(int day = default, string typeName = @"WeekDay") : base(typeName)
        {
            this.Day = day;
        }
        ...
        /// </summary>
        /// <value>ISO-8601 day of the week (1 &#x3D; Monday, 7 &#x3D; Sunday).</value>
        /*
        <example>1</example>
        */
        ...
        protected IEnumerable<ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            if (this.Day > (int)7)
            {
                yield return new ValidationResult("Invalid value for Day, must be a value less than or equal to 7.", new [] { "Day" });
            }
