...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleNodeDepot : INodeDepot, IValidatableObject
    {
        ...
        public SimpleNodeDepot(string typeName = @"SimpleNodeDepot", List<ILoad> items = default, bool hasFlexLoad = default, string depotId = default, bool hasTimedLoads = default) : base(items, hasFlexLoad, depotId, hasTimedLoads)
        {
