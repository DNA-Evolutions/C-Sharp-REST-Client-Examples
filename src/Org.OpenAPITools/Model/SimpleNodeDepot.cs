...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleNodeDepot : INodeDepot, IEquatable<SimpleNodeDepot>, IValidatableObject
    {
        ...
        public SimpleNodeDepot(string typeName = "SimpleNodeDepot", List<ILoad> items = default(List<ILoad>), bool hasTimedLoads = default(bool), string depotId = default(string), bool hasFlexLoad = default(bool)) : base(items, hasTimedLoads, depotId, hasFlexLoad)
        {
