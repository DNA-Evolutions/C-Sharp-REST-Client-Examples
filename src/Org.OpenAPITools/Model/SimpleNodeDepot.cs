...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleNodeDepot : INodeDepot, IValidatableObject
    {
        ...
        public SimpleNodeDepot(string typeName = @"SimpleNodeDepot", List<ILoad> items = default(List<ILoad>), bool hasFlexLoad = default(bool), bool hasTimedLoads = default(bool), string depotId = default(string)) : base(items, hasFlexLoad, hasTimedLoads, depotId)
        {
