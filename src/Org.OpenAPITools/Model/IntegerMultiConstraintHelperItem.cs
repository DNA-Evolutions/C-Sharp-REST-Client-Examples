...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IntegerMultiConstraintHelperItem : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="IntegerMultiConstraintHelperItem" /> class.
        /// </summary>
        /// <param name="pairs">A list of key-value pairs mapping element identifiers to integer values. Used internally to mirror multi-route constraint configurations across working hours. (required).</param>
        public IntegerMultiConstraintHelperItem(List<StringIntegerPair> pairs = default)
        {
        ...
        /// </summary>
        /// <value>A list of key-value pairs mapping element identifiers to integer values. Used internally to mirror multi-route constraint configurations across working hours.</value>
