...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IntegerMultiConstraintHelperItem : IEquatable<IntegerMultiConstraintHelperItem>, IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "pairs", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as IntegerMultiConstraintHelperItem);
        }

        /// <summary>
        /// Returns true if IntegerMultiConstraintHelperItem instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegerMultiConstraintHelperItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegerMultiConstraintHelperItem input)
        {
            if (input == null)
            {
                return false;
