...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DegradingLoadCapacity : ILoadCapacity, IValidatableObject
    {
        ...
        public DegradingLoadCapacity(string loadCapacityId = default, int maxCapacityValue = default, double capacityDegradationPerStop = default, double minimalTotaDegradatedCapacity = default, string typeName = @"DegradingLoadCapacity", double maximalIndividualLoadCapacity = default, double currentLoad = default, long loadPickupTime = default, string id = default) : base(maximalIndividualLoadCapacity, currentLoad, loadPickupTime, id)
        {
