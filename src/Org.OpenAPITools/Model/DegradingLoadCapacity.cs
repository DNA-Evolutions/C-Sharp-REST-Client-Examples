...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DegradingLoadCapacity : ILoadCapacity, IValidatableObject
    {
        ...
        public DegradingLoadCapacity(string loadCapacityId = default(string), int maxCapacityValue = default(int), double capacityDegradationPerStop = default(double), double minimalTotaDegradatedCapacity = default(double), string typeName = @"DegradingLoadCapacity", long loadPickupTime = default(long), double currentLoad = default(double), double maximalIndividualLoadCapacity = default(double), string id = default(string)) : base(loadPickupTime, currentLoad, maximalIndividualLoadCapacity, id)
        {
