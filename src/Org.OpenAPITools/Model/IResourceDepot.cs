...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IResourceDepot : IEquatable<IResourceDepot>, IValidatableObject
    {
        /// <summary>
        ...
        public IResourceDepot(List<ILoadCapacity> items = default(List<ILoadCapacity>), string depotId = default(string), double maximalTotalCapacity = default(double), Dictionary<string, double> capacityUnitMap = default(Dictionary<string, double>), string typeName = default(string))
        {
        ...
        {
            return this.Equals(input as IResourceDepot);
        }

        /// <summary>
        /// Returns true if IResourceDepot instances are equal
        /// </summary>
        /// <param name="input">Instance of IResourceDepot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IResourceDepot input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MaximalTotalCapacity == input.MaximalTotalCapacity ||
                    this.MaximalTotalCapacity.Equals(input.MaximalTotalCapacity)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MaximalTotalCapacity.GetHashCode();
