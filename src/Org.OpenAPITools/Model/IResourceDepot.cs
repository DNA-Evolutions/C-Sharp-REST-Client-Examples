...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IResourceDepot : IValidatableObject
    {
        ...
        public IResourceDepot(List<ILoadCapacity> items = default, double maximalTotalCapacity = default, string depotId = default, Dictionary<string, double> capacityUnitMap = default, string typeName = default)
        {
