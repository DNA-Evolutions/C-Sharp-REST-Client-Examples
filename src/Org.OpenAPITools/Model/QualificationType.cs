...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QualificationType")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(BitTypeQualification), "BitType")]
    [JsonSubtypes.KnownSubType(typeof(BitTypeWithExpertiseQualification), "BitTypeWithExpertise")]
    ...
    public partial class QualificationType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QualificationType" /> class.
        /// </summary>
        ...
        public QualificationType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for QualificationType and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QualificationType {\n");
