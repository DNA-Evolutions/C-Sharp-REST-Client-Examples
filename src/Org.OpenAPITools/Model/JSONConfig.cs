...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JSONConfig : IValidatableObject
    {
        ...
        public JSONConfig(CreatorSetting creatorSetting = default, TextSolution textSolution = default, OptimizationKeySetting keySetting = default, OptimizationPersistenceSetting persistenceSetting = default, PluginSettings pluginSettings = default, string timeOut = default)
        {
