...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeDictionary : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="TypeDictionary" /> class.
        /// </summary>
        /// <param name="mapping">The mapping of a certain type. or multiple types (required).</param>
        /// <param name="typeNames">List of type names this dictionary applies to. (required).</param>
        public TypeDictionary(Dictionary<string, string> mapping = default, List<string> typeNames = default)
        {
            // to ensure "mapping" is required (not null)
            if (mapping == null)
            {
                throw new ArgumentNullException("mapping is a required property for TypeDictionary and cannot be null");
            }
            this.Mapping = mapping;
            // to ensure "typeNames" is required (not null)
            if (typeNames == null)
            {
                throw new ArgumentNullException("typeNames is a required property for TypeDictionary and cannot be null");
            }
        ...
        /// <summary>
        /// List of type names this dictionary applies to.
        /// </summary>
        /// <value>List of type names this dictionary applies to.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypeDictionary {\n");
