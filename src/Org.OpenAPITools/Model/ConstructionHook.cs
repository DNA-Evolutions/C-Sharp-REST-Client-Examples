...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConstructionHook")]
    public partial class ConstructionHook : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionHook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConstructionHook() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructionHook" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public ConstructionHook(HookType type = default)
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ConstructionHook and cannot be null");
            }
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConstructionHook {\n");
