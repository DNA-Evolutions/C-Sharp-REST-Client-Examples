...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DateDef")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(AnyDef), "Any")]
    [JsonSubtypes.KnownSubType(typeof(Day), "Day")]
    [JsonSubtypes.KnownSubType(typeof(DayMonth), "DayMonth")]
    [JsonSubtypes.KnownSubType(typeof(DayMonthYear), "DayMonthYear")]
    [JsonSubtypes.KnownSubType(typeof(RangeDay), "Range.Day")]
    [JsonSubtypes.KnownSubType(typeof(RangeDayMonth), "Range.DayMonth")]
    [JsonSubtypes.KnownSubType(typeof(RangeDayMonthYear), "Range.DayMonthYear")]
    [JsonSubtypes.KnownSubType(typeof(RangeWeekDay), "Range.WeekDay")]
    [JsonSubtypes.KnownSubType(typeof(WeekDay), "WeekDay")]
    public partial class DateDef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateDef" /> class.
        /// </summary>
        ...
        public DateDef(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for DateDef and cannot be null");
            }
