...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DateDef : IEquatable<DateDef>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DateDef);
        }

        /// <summary>
        /// Returns true if DateDef instances are equal
        /// </summary>
        /// <param name="input">Instance of DateDef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateDef input)
        {
            if (input == null)
            {
                return false;
