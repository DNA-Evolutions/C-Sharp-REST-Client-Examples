...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LongLongPair : IEquatable<LongLongPair>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LongLongPair);
        }

        /// <summary>
        /// Returns true if LongLongPair instances are equal
        /// </summary>
        /// <param name="input">Instance of LongLongPair to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LongLongPair input)
        {
            if (input == null)
            {
                return false;
