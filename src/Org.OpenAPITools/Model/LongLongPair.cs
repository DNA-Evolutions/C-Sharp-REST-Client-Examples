...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LongLongPair : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="LongLongPair" /> class.
        /// </summary>
        /// <param name="left">The start offset value (in milliseconds). (required).</param>
        /// <param name="right">The end offset value (in milliseconds). (required).</param>
        public LongLongPair(long left = default, long right = default)
        {
            this.Left = left;
            this.Right = right;
        }
        ...
        /// <summary>
        /// The start offset value (in milliseconds).
        /// </summary>
        /// <value>The start offset value (in milliseconds).</value>
        [DataMember(Name = "left", IsRequired = true, EmitDefaultValue = true)]
        public long Left { get; set; }

        /// <summary>
        /// The end offset value (in milliseconds).
        /// </summary>
        /// <value>The end offset value (in milliseconds).</value>
