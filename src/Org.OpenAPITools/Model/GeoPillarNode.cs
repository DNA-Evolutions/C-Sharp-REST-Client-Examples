...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GeoPillarNode : IEquatable<GeoPillarNode>, IValidatableObject
    {
        ...
        public GeoPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), ConnectionRelatedLateMargin connectionRelatedLateMargin = default(ConnectionRelatedLateMargin), bool isForcedStayNode = default(bool), bool isAutoTransformable2StartAnchor = default(bool), bool isOverwritingRouteStart = default(bool), bool isOverwritingRouteTermination = default(bool), bool isSchedulableBeforeWorkingHours = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isTimeAdjustableAnchor = default(bool))
        {
