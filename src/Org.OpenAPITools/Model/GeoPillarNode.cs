...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GeoPillarNode : IValidatableObject
    {
        ...
        public GeoPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), ConnectionRelatedLateMargin connectionRelatedLateMargin = default(ConnectionRelatedLateMargin), bool isAutoTransformable2StartAnchor = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isOverwritingRouteStart = default(bool), bool isOverwritingRouteTermination = default(bool), bool isTimeAdjustableAnchor = default(bool), bool isSchedulableBeforeWorkingHours = default(bool), bool isForcedStayNode = default(bool))
        {
