...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GeoPillarNode : IEquatable<GeoPillarNode>, IValidatableObject
    {
        /// <summary>
        ...
        public GeoPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), ConnectionRelatedLateMargin connectionRelatedLateMargin = default(ConnectionRelatedLateMargin), bool isAutoTransformable2StartAnchor = default(bool), bool isSchedulableBeforeWorkingHours = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isOverwritingRouteStart = default(bool), bool isTimeAdjustableAnchor = default(bool), bool isOverwritingRouteTermination = default(bool), bool isForcedStayNode = default(bool))
        {
        ...
        {
            return this.Equals(input as GeoPillarNode);
        }

        /// <summary>
        /// Returns true if GeoPillarNode instances are equal
        /// </summary>
        /// <param name="input">Instance of GeoPillarNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeoPillarNode input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ConnectionRelatedLateMargin == input.ConnectionRelatedLateMargin ||
                    (this.ConnectionRelatedLateMargin != null &&
                    this.ConnectionRelatedLateMargin.Equals(input.ConnectionRelatedLateMargin))
                ) && 
                (
                    this.IsAutoTransformable2StartAnchor == input.IsAutoTransformable2StartAnchor ||
                    this.IsAutoTransformable2StartAnchor.Equals(input.IsAutoTransformable2StartAnchor)
                ) && 
                (
                ...
                (
                    this.IsOverwritingRouteStart == input.IsOverwritingRouteStart ||
                    this.IsOverwritingRouteStart.Equals(input.IsOverwritingRouteStart)
                ) && 
                (
                ...
                (
                    this.IsForcedStayNode == input.IsForcedStayNode ||
                    this.IsForcedStayNode.Equals(input.IsForcedStayNode)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConnectionRelatedLateMargin != null)
                {
                    hashCode = (hashCode * 59) + this.ConnectionRelatedLateMargin.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.IsAutoTransformable2StartAnchor.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.IsOverwritingRouteStart.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.IsForcedStayNode.GetHashCode();
                return hashCode;
            }
        }
