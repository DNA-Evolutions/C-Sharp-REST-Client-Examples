...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StartReductionTimeDefinition : IValidatableObject
    {
        /// <summary>
        ...
        public StartReductionTimeDefinition(string maxRouteStartReductionTime = default, bool isReductionTimeOnlyUsedForDriving = default)
        {
        ...
        */
        [DataMember(Name = "maxRouteStartReductionTime", IsRequired = true, EmitDefaultValue = true)]
