...
namespace Org.OpenAPITools.Model
{
    ...
    /// UnloadAllLoadAllOf
    /// </summary>
    [DataContract(Name = "UnloadAllLoad_allOf")]
    public partial class UnloadAllLoadAllOf : IEquatable<UnloadAllLoadAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnloadAllLoadAllOf" /> class.
        /// </summary>
        /// <param name="loadId">loadId.</param>
        /// <param name="isRequest">isRequest.</param>
        /// <param name="isFuzzyVisit">isFuzzyVisit.</param>
        /// <param name="typeName">The typeName of the object (default to &quot;UnloadAllLoad&quot;).</param>
        public UnloadAllLoadAllOf(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "UnloadAllLoad")
        {
            this.LoadId = loadId;
            this.IsRequest = isRequest;
            this.IsFuzzyVisit = isFuzzyVisit;
            // use default value if no "typeName" provided
            this.TypeName = typeName ?? "UnloadAllLoad";
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnloadAllLoadAllOf {\n");
        ...
        {
            return this.Equals(input as UnloadAllLoadAllOf);
        }

        /// <summary>
        /// Returns true if UnloadAllLoadAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UnloadAllLoadAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnloadAllLoadAllOf input)
        {
            if (input == null)
            {
                return false;
