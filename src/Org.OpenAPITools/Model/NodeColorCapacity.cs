...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NodeColorCapacity : IEquatable<NodeColorCapacity>, IValidatableObject
    {
        /// <summary>
        ...
        public NodeColorCapacity(NodeColor nodeColor = default(NodeColor), double maxUsage = default(double))
        {
        ...
        {
            return this.Equals(input as NodeColorCapacity);
        }

        /// <summary>
        /// Returns true if NodeColorCapacity instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeColorCapacity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeColorCapacity input)
        {
            if (input == null)
            {
                return false;
