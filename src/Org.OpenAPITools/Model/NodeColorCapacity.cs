...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NodeColorCapacity")]
    public partial class NodeColorCapacity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeColorCapacity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NodeColorCapacity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeColorCapacity" /> class.
        /// </summary>
        /// <param name="nodeColor">nodeColor (required).</param>
        /// <param name="maxUsage">The maximum usage ratio (0.0–1.0) of this node color within a single route. For example, 0.5 means at most 50% of the nodes on a route may carry this color. (required).</param>
        public NodeColorCapacity(NodeColor nodeColor = default, double maxUsage = default)
        {
            // to ensure "nodeColor" is required (not null)
            if (nodeColor == null)
            {
                throw new ArgumentNullException("nodeColor is a required property for NodeColorCapacity and cannot be null");
            }
        ...
        /// <summary>
        /// The maximum usage ratio (0.0–1.0) of this node color within a single route. For example, 0.5 means at most 50% of the nodes on a route may carry this color.
        /// </summary>
        /// <value>The maximum usage ratio (0.0–1.0) of this node color within a single route. For example, 0.5 means at most 50% of the nodes on a route may carry this color.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NodeColorCapacity {\n");
