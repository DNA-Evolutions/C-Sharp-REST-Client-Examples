...
{
    /// <summary>
    /// ZoneNumberConstraintAllOf
    /// </summary>
    [DataContract(Name = "ZoneNumberConstraint_allOf")]
    public partial class ZoneNumberConstraintAllOf : IEquatable<ZoneNumberConstraintAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZoneNumberConstraintAllOf" /> class.
        /// </summary>
        /// <param name="zoneCodes">The zoneCodes.</param>
        /// <param name="typeName">The typeName of the object (default to &quot;ZoneNumberConstraint&quot;).</param>
        public ZoneNumberConstraintAllOf(List<ZoneNumber> zoneCodes = default(List<ZoneNumber>), string typeName = "ZoneNumberConstraint")
        {
            this.ZoneCodes = zoneCodes;
            // use default value if no "typeName" provided
            this.TypeName = typeName ?? "ZoneNumberConstraint";
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZoneNumberConstraintAllOf {\n");
        ...
        {
            return this.Equals(input as ZoneNumberConstraintAllOf);
        }

        /// <summary>
        /// Returns true if ZoneNumberConstraintAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ZoneNumberConstraintAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZoneNumberConstraintAllOf input)
        {
            if (input == null)
            {
                return false;
