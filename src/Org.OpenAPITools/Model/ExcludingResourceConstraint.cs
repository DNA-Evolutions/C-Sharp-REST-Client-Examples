...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ExcludingResourceConstraint : ConstraintType, IEquatable<ExcludingResourceConstraint>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ExcludingResourceConstraint);
        }

        /// <summary>
        /// Returns true if ExcludingResourceConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludingResourceConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludingResourceConstraint input)
        {
            if (input == null)
            {
                return false;
