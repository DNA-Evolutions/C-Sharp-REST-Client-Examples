...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DatabaseInfoSearch : IValidatableObject
    {
        ...
        public DatabaseInfoSearch(string creator = default, string ident = default, int limit = default, string sortDirection = default, DateTime createdDateStart = default, DateTime createdDateEnd = default, string timeOut = default)
        {
