...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventPillarNode : IEquatable<EventPillarNode>, IValidatableObject
    {
        ...
        public EventPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), bool isSchedulableBeforeWorkingHours = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isTimeAdjustableAnchor = default(bool), bool isOverwritingRouteTermination = default(bool), bool isExtendableEnd = default(bool))
        {
