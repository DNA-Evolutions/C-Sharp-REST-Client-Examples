...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventPillarNode : PillarType, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EventPillarNode" /> class.
        /// </summary>
        /// <param name="attachedResourceId">The attached resourceId. An event pillar must be visited by this specific resource. The optimizer guarantees architectural compliance — this is a hard constraint..</param>
        /// <param name="onlyScheduledInCompany">If true, this event pillar is only scheduled when the attached resource belongs to the same organizational group. Prevents cross-company assignments in multi-fleet scenarios..</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;EventPillarNode&quot;).</param>
        /// <param name="isExtendableEnd">If true, the event pillar&#39;s end time can be extended beyond its defined opening-hour boundary to accommodate scheduling needs. Useful for flexible-duration events like meetings or calls..</param>
        /// <param name="isSchedulableAfterWorkingHours">If true, the optimizer may schedule this event pillar after the resource&#39;s official working-hours end. Enables post-shift mandatory events (e.g. end-of-day reporting, handover calls)..</param>
        ...
        /// <param name="isSchedulableBeforeWorkingHours">If true, the optimizer may schedule this event pillar before the resource&#39;s official working-hours start. Enables pre-shift mandatory events (e.g. morning briefings, pre-route phone calls)..</param>
        /// <param name="isTimeAdjustableAnchor">If true, the anchor timing derived from this event pillar is allowed to shift within the working-hour boundaries. Enables the optimizer to adjust the schedule around fixed events while maintaining the pillar&#39;s role as a route anchor point..</param>
        public EventPillarNode(string attachedResourceId = default, bool onlyScheduledInCompany = default, string typeName = @"EventPillarNode", bool isExtendableEnd = default, bool isSchedulableAfterWorkingHours = default, bool isOverwritingRouteTermination = default, bool isSchedulableBeforeWorkingHours = default, bool isTimeAdjustableAnchor = default) : base()
        {
        ...
        /// <summary>
        /// The attached resourceId. An event pillar must be visited by this specific resource. The optimizer guarantees architectural compliance — this is a hard constraint.
        /// </summary>
        /// <value>The attached resourceId. An event pillar must be visited by this specific resource. The optimizer guarantees architectural compliance — this is a hard constraint.</value>
        [DataMember(Name = "attachedResourceId", EmitDefaultValue = false)]
        public string AttachedResourceId { get; set; }

        /// <summary>
        /// If true, this event pillar is only scheduled when the attached resource belongs to the same organizational group. Prevents cross-company assignments in multi-fleet scenarios.
        /// </summary>
        /// <value>If true, this event pillar is only scheduled when the attached resource belongs to the same organizational group. Prevents cross-company assignments in multi-fleet scenarios.</value>
        ...
        */
        ...
        /// <summary>
        /// If true, the event pillar&#39;s end time can be extended beyond its defined opening-hour boundary to accommodate scheduling needs. Useful for flexible-duration events like meetings or calls.
        /// </summary>
        /// <value>If true, the event pillar&#39;s end time can be extended beyond its defined opening-hour boundary to accommodate scheduling needs. Useful for flexible-duration events like meetings or calls.</value>
        [DataMember(Name = "isExtendableEnd", EmitDefaultValue = true)]
        public bool IsExtendableEnd { get; set; }

        /// <summary>
        /// If true, the optimizer may schedule this event pillar after the resource&#39;s official working-hours end. Enables post-shift mandatory events (e.g. end-of-day reporting, handover calls).
        /// </summary>
        /// <value>If true, the optimizer may schedule this event pillar after the resource&#39;s official working-hours end. Enables post-shift mandatory events (e.g. end-of-day reporting, handover calls).</value>
        ...
        /// <summary>
        /// If true, the optimizer may schedule this event pillar before the resource&#39;s official working-hours start. Enables pre-shift mandatory events (e.g. morning briefings, pre-route phone calls).
        /// </summary>
        /// <value>If true, the optimizer may schedule this event pillar before the resource&#39;s official working-hours start. Enables pre-shift mandatory events (e.g. morning briefings, pre-route phone calls).</value>
        [DataMember(Name = "isSchedulableBeforeWorkingHours", EmitDefaultValue = true)]
        public bool IsSchedulableBeforeWorkingHours { get; set; }

        /// <summary>
        /// If true, the anchor timing derived from this event pillar is allowed to shift within the working-hour boundaries. Enables the optimizer to adjust the schedule around fixed events while maintaining the pillar&#39;s role as a route anchor point.
        /// </summary>
        /// <value>If true, the anchor timing derived from this event pillar is allowed to shift within the working-hour boundaries. Enables the optimizer to adjust the schedule around fixed events while maintaining the pillar&#39;s role as a route anchor point.</value>
