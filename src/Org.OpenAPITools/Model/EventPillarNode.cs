...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventPillarNode : IValidatableObject
    {
        ...
        public EventPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), bool isTimeAdjustableAnchor = default(bool), bool isSchedulableBeforeWorkingHours = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isOverwritingRouteTermination = default(bool), bool isExtendableEnd = default(bool))
        {
