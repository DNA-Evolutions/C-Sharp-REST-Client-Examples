...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventPillarNode : IValidatableObject
    {
        /// <summary>
        ...
        public EventPillarNode(string attachedResourceId = default(string), bool onlyScheduledInCompany = default(bool), bool isExtendableEnd = default(bool), bool isSchedulableAfterWorkingHours = default(bool), bool isOverwritingRouteTermination = default(bool), bool isTimeAdjustableAnchor = default(bool), bool isSchedulableBeforeWorkingHours = default(bool))
        {
