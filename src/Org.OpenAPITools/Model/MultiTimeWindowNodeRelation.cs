...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MultiTimeWindowNodeRelation : NodeRelationType, IValidatableObject
    {
        /// <summary>
        ...
        public MultiTimeWindowNodeRelation(string typeName = @"MultiTimeWindow", List<RouteElementDetail> anchorDetails = default, bool isNeedSameVisitor = default, bool isOverlapAllowed = default) : base()
        {
        ...
        /*
        <example>MultiTimeWindow</example>
        */
