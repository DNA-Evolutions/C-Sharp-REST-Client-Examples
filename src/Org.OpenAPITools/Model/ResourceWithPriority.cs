...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResourceWithPriority : IValidatableObject
    {
        ...
        /// <param name="priority">The scheduling priority for this resource within the constraint. When multiple resources are eligible, the optimizer prefers the one with the highest priority value. (required).</param>
        ...
        */
        ...
        /// <summary>
        /// The scheduling priority for this resource within the constraint. When multiple resources are eligible, the optimizer prefers the one with the highest priority value.
        /// </summary>
        /// <value>The scheduling priority for this resource within the constraint. When multiple resources are eligible, the optimizer prefers the one with the highest priority value.</value>
        /*
        <example>5</example>
        */
