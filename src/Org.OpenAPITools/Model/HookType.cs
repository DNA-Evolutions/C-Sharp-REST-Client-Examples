...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HookType")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(MaxDistanceConstructionHook), "MaxDistanceConstructionHook")]
    public partial class HookType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HookType" /> class.
        /// </summary>
        ...
        public HookType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for HookType and cannot be null");
            }
