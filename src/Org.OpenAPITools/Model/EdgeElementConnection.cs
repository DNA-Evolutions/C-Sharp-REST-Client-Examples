...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EdgeElementConnection : ElementConnectionType, IValidatableObject
    {
        ...
        public EdgeElementConnection(string distance = default, string time = default, Position fromPosition = default, Position toPosition = default, ConnectionByTime connectionByTime = default, string typeName = @"Edge") : base()
        {
