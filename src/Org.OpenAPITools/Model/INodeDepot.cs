...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class INodeDepot : IValidatableObject
    {
        ...
        public INodeDepot(List<ILoad> items = default(List<ILoad>), bool hasFlexLoad = default(bool), bool hasTimedLoads = default(bool), string depotId = default(string), string typeName = default(string))
        {
