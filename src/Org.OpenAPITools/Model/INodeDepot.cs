...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class INodeDepot : IEquatable<INodeDepot>, IValidatableObject
    {
        ...
        public INodeDepot(List<ILoad> items = default(List<ILoad>), string depotId = default(string), bool hasFlexLoad = default(bool), bool hasTimedLoads = default(bool), string typeName = default(string))
        {
