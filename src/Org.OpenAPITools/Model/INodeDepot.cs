...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class INodeDepot : IValidatableObject
    {
        ...
        public INodeDepot(List<ILoad> items = default(List<ILoad>), string depotId = default(string), bool hasTimedLoads = default(bool), bool hasFlexLoad = default(bool), string typeName = default(string))
        {
