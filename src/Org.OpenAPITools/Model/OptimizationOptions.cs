...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OptimizationOptions : IValidatableObject
    {
        ...
        /// <param name="optimizationSchemeOptions">optimizationSchemeOptions.</param>
        public OptimizationOptions(Dictionary<string, string> properties = default, OptimizationSchemeOptions optimizationSchemeOptions = default)
        {
            ...
            this.OptimizationSchemeOptions = optimizationSchemeOptions;
        }
        ...
        /// <summary>
        /// Gets or Sets OptimizationSchemeOptions
        /// </summary>
        [DataMember(Name = "optimizationSchemeOptions", EmitDefaultValue = false)]
        public OptimizationSchemeOptions OptimizationSchemeOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OptimizationSchemeOptions: ").Append(OptimizationSchemeOptions).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
