...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TimeComparisonJuncture : IEquatable<TimeComparisonJuncture>, IValidatableObject
    {
        /// <summary>
        ...
        public TimeComparisonJuncture(bool isRelatedNodeWorkingStart = default(bool), bool isMasterNodeWorkingStart = default(bool))
        {
        ...
        {
            return this.Equals(input as TimeComparisonJuncture);
        }

        /// <summary>
        /// Returns true if TimeComparisonJuncture instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeComparisonJuncture to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeComparisonJuncture input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.IsRelatedNodeWorkingStart == input.IsRelatedNodeWorkingStart ||
                    this.IsRelatedNodeWorkingStart.Equals(input.IsRelatedNodeWorkingStart)
                ) && 
                (
                    this.IsMasterNodeWorkingStart == input.IsMasterNodeWorkingStart ||
                    this.IsMasterNodeWorkingStart.Equals(input.IsMasterNodeWorkingStart)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.IsRelatedNodeWorkingStart.GetHashCode();
                hashCode = (hashCode * 59) + this.IsMasterNodeWorkingStart.GetHashCode();
                return hashCode;
            }
        }
