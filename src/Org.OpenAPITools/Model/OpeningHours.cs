...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OpeningHours : IEquatable<OpeningHours>, IValidatableObject
    {
        ...
        public OpeningHours(DateTime begin = default(DateTime), DateTime end = default(DateTime), string zoneId = default(string), List<LongLongPair> serviceHoursOffsets = default(List<LongLongPair>), bool? isSoloAccessHours = false, bool? isPreffered = false)
        {
            this.Begin = begin;
            this.End = end;
