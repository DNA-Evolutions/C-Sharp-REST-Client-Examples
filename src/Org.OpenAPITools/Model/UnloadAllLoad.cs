...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UnloadAllLoad : ILoad, IValidatableObject
    {
        ...
        public UnloadAllLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = @"UnloadAllLoad", int priority = default(int), bool request = default(bool), double loadValue = default(double), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, request, loadValue, fuzzyVisit, id)
        {
