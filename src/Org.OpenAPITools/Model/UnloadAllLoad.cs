...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UnloadAllLoad : ILoad, IEquatable<UnloadAllLoad>, IValidatableObject
    {
        /// <summary>
        ...
        public UnloadAllLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "UnloadAllLoad", int priority = default(int), bool fuzzyVisit = default(bool), bool request = default(bool), double loadValue = default(double), string id = default(string)) : base(priority, fuzzyVisit, request, loadValue, id)
        {
        ...
        {
            return this.Equals(input as UnloadAllLoad);
        }

        /// <summary>
        /// Returns true if UnloadAllLoad instances are equal
        /// </summary>
        /// <param name="input">Instance of UnloadAllLoad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnloadAllLoad input)
        {
            if (input == null)
            {
                return false;
