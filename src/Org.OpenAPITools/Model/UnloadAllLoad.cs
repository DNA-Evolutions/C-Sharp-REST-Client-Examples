...
namespace Org.OpenAPITools.Model
{
    ...
    /// UnloadAllLoad
    /// </summary>
    [DataContract(Name = "UnloadAllLoad")]
    public partial class UnloadAllLoad : ILoad, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnloadAllLoad" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnloadAllLoad() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnloadAllLoad" /> class.
        /// </summary>
        ...
        /// <param name="typeName">The typeName of the object (required) (default to &quot;UnloadAllLoad&quot;).</param>
        /// <param name="priority">priority.</param>
        /// <param name="loadValue">loadValue.</param>
        /// <param name="request">request.</param>
        /// <param name="fuzzyVisit">fuzzyVisit.</param>
        /// <param name="id">id.</param>
        public UnloadAllLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"UnloadAllLoad", int priority = default, double loadValue = default, bool request = default, bool fuzzyVisit = default, string id = default) : base(priority, loadValue, request, fuzzyVisit, id)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for UnloadAllLoad and cannot be null");
            }
