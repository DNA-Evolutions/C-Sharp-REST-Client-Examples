...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UnloadAllLoad : ILoad, IValidatableObject
    {
        ...
        public UnloadAllLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"UnloadAllLoad", int priority = default, bool fuzzyVisit = default, double loadValue = default, bool request = default, string id = default) : base(priority, fuzzyVisit, loadValue, request, id)
        {
