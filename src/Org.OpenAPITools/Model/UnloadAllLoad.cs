...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UnloadAllLoad : ILoad, IEquatable<UnloadAllLoad>, IValidatableObject
    {
        ...
        public UnloadAllLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "UnloadAllLoad", int priority = default(int), double loadValue = default(double), bool request = default(bool), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, loadValue, request, fuzzyVisit, id)
        {
