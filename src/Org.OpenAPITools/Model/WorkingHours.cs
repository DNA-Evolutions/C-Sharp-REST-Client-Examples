...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WorkingHours : IEquatable<WorkingHours>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WorkingHours);
        }

        /// <summary>
        /// Returns true if WorkingHours instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkingHours to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkingHours input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LocalFlexTime == input.LocalFlexTime ||
                    (this.LocalFlexTime != null &&
                    this.LocalFlexTime.Equals(input.LocalFlexTime))
                ) && 
                (
                    this.LocalPostFlexTime == input.LocalPostFlexTime ||
                    (this.LocalPostFlexTime != null &&
                    this.LocalPostFlexTime.Equals(input.LocalPostFlexTime))
                ) && 
                (
                    this.LocalPostFlexTimeOnlyOnOvertime == input.LocalPostFlexTimeOnlyOnOvertime ||
                    (this.LocalPostFlexTimeOnlyOnOvertime != null &&
                    this.LocalPostFlexTimeOnlyOnOvertime.Equals(input.LocalPostFlexTimeOnlyOnOvertime))
                ) && 
                (
                    this.MaxLocalPillarAfterHoursTime == input.MaxLocalPillarAfterHoursTime ||
                    (this.MaxLocalPillarAfterHoursTime != null &&
                    this.MaxLocalPillarAfterHoursTime.Equals(input.MaxLocalPillarAfterHoursTime))
                ) && 
                (
                ...
                (
                    this.WorkingHoursConstraints == input.WorkingHoursConstraints ||
                    this.WorkingHoursConstraints != null &&
                    input.WorkingHoursConstraints != null &&
                    this.WorkingHoursConstraints.SequenceEqual(input.WorkingHoursConstraints)
                ) && 
                (
                    this.MultiWorkingHoursConstraints == input.MultiWorkingHoursConstraints ||
                    this.MultiWorkingHoursConstraints != null &&
                    input.MultiWorkingHoursConstraints != null &&
                    this.MultiWorkingHoursConstraints.SequenceEqual(input.MultiWorkingHoursConstraints)
                ) && 
                (
                ...
                (
                    this.RouteStartTimeHook == input.RouteStartTimeHook ||
                    (this.RouteStartTimeHook != null &&
                    this.RouteStartTimeHook.Equals(input.RouteStartTimeHook))
                ) && 
                (
                    this.IsClosedRoute == input.IsClosedRoute ||
                    (this.IsClosedRoute != null &&
                    this.IsClosedRoute.Equals(input.IsClosedRoute))
                ) && 
                (
                    this.IsAvailableForStay == input.IsAvailableForStay ||
                    (this.IsAvailableForStay != null &&
                    this.IsAvailableForStay.Equals(input.IsAvailableForStay))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LocalFlexTime != null)
                {
                    hashCode = (hashCode * 59) + this.LocalFlexTime.GetHashCode();
                }
                if (this.LocalPostFlexTime != null)
                {
                    hashCode = (hashCode * 59) + this.LocalPostFlexTime.GetHashCode();
                }
                if (this.LocalPostFlexTimeOnlyOnOvertime != null)
                {
                    hashCode = (hashCode * 59) + this.LocalPostFlexTimeOnlyOnOvertime.GetHashCode();
                }
                if (this.MaxLocalPillarAfterHoursTime != null)
                {
                    hashCode = (hashCode * 59) + this.MaxLocalPillarAfterHoursTime.GetHashCode();
                }
                if (this.NodeColorCapacities != null)
                {
                    hashCode = (hashCode * 59) + this.NodeColorCapacities.GetHashCode();
                }
                if (this.WorkingHoursConstraints != null)
                {
                    hashCode = (hashCode * 59) + this.WorkingHoursConstraints.GetHashCode();
                }
                if (this.MultiWorkingHoursConstraints != null)
                {
                    hashCode = (hashCode * 59) + this.MultiWorkingHoursConstraints.GetHashCode();
                }
                if (this.Qualifications != null)
                {
                    hashCode = (hashCode * 59) + this.Qualifications.GetHashCode();
                }
                if (this.RouteStartTimeHook != null)
                {
                    hashCode = (hashCode * 59) + this.RouteStartTimeHook.GetHashCode();
                }
                if (this.IsClosedRoute != null)
                {
                    hashCode = (hashCode * 59) + this.IsClosedRoute.GetHashCode();
                }
                if (this.IsAvailableForStay != null)
                {
                    hashCode = (hashCode * 59) + this.IsAvailableForStay.GetHashCode();
                }
                return hashCode;
            }
        }
