...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UKPostCode : ZoneCodeType, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UKPostCode" /> class.
        /// </summary>
        /// <param name="areaIdent">The area identifier of the UK postcode (e.g. &#39;SW&#39;, &#39;EC&#39;, &#39;M&#39;). This is the outward code&#39;s letter prefix that identifies the postal area. (required).</param>
        /// <param name="districtIdentOpt">The optional district number within the postal area (e.g. 1 in &#39;SW1&#39;)..</param>
        /// <param name="sectorIdentOpt">The optional sector number from the inward code (e.g. 4 in &#39;SW1A 4&#39;)..</param>
        /// <param name="unitIdentOpt">The optional unit identifier from the inward code (e.g. &#39;AA&#39; in &#39;SW1A 4AA&#39;)..</param>
        ...
        /// <summary>
        /// The area identifier of the UK postcode (e.g. &#39;SW&#39;, &#39;EC&#39;, &#39;M&#39;). This is the outward code&#39;s letter prefix that identifies the postal area.
        /// </summary>
        /// <value>The area identifier of the UK postcode (e.g. &#39;SW&#39;, &#39;EC&#39;, &#39;M&#39;). This is the outward code&#39;s letter prefix that identifies the postal area.</value>
        [DataMember(Name = "areaIdent", IsRequired = true, EmitDefaultValue = true)]
        public string AreaIdent { get; set; }

        /// <summary>
        /// The optional district number within the postal area (e.g. 1 in &#39;SW1&#39;).
        /// </summary>
        /// <value>The optional district number within the postal area (e.g. 1 in &#39;SW1&#39;).</value>
        [DataMember(Name = "districtIdentOpt", EmitDefaultValue = false)]
        public int DistrictIdentOpt { get; set; }

        /// <summary>
        /// The optional sector number from the inward code (e.g. 4 in &#39;SW1A 4&#39;).
        /// </summary>
        /// <value>The optional sector number from the inward code (e.g. 4 in &#39;SW1A 4&#39;).</value>
        [DataMember(Name = "sectorIdentOpt", EmitDefaultValue = false)]
        public int SectorIdentOpt { get; set; }

        /// <summary>
        /// The optional unit identifier from the inward code (e.g. &#39;AA&#39; in &#39;SW1A 4AA&#39;).
        /// </summary>
        /// <value>The optional unit identifier from the inward code (e.g. &#39;AA&#39; in &#39;SW1A 4AA&#39;).</value>
