...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StayOutDefinition : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="StayOutDefinition" /> class.
        /// </summary>
        /// <param name="maxTotalStaysOut">The maximum total number of overnight stays the resource may have across all working-hour cycles. (required).</param>
        /// <param name="maxStaysOutInRow">The maximum number of consecutive overnight stays in a row before the resource must return home or observe a recovery period. (required).</param>
        /// <param name="minRecovery">The minimum recovery duration the resource must spend at its home location before another stay-out sequence is permitted. Expressed as an ISO 8601 duration (e.g. &#39;PT24H&#39; for one full day). (required).</param>
        public StayOutDefinition(int maxTotalStaysOut = default, int maxStaysOutInRow = default, string minRecovery = default)
        {
        ...
        /// <summary>
        /// The maximum total number of overnight stays the resource may have across all working-hour cycles.
        /// </summary>
        /// <value>The maximum total number of overnight stays the resource may have across all working-hour cycles.</value>
        [DataMember(Name = "maxTotalStaysOut", IsRequired = true, EmitDefaultValue = true)]
        public int MaxTotalStaysOut { get; set; }

        /// <summary>
        /// The maximum number of consecutive overnight stays in a row before the resource must return home or observe a recovery period.
        /// </summary>
        /// <value>The maximum number of consecutive overnight stays in a row before the resource must return home or observe a recovery period.</value>
        [DataMember(Name = "maxStaysOutInRow", IsRequired = true, EmitDefaultValue = true)]
        public int MaxStaysOutInRow { get; set; }

        /// <summary>
        /// The minimum recovery duration the resource must spend at its home location before another stay-out sequence is permitted. Expressed as an ISO 8601 duration (e.g. &#39;PT24H&#39; for one full day).
        /// </summary>
        /// <value>The minimum recovery duration the resource must spend at its home location before another stay-out sequence is permitted. Expressed as an ISO 8601 duration (e.g. &#39;PT24H&#39; for one full day).</value>
        /*
