...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeWithExpertiseQualification : QualificationType, IEquatable<TypeWithExpertiseQualification>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TypeWithExpertiseQualification);
        }

        /// <summary>
        /// Returns true if TypeWithExpertiseQualification instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeWithExpertiseQualification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeWithExpertiseQualification input)
        {
            if (input == null)
            {
                return false;
