...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeWithExpertiseQualification : QualificationType, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TypeWithExpertiseQualification" /> class.
        /// </summary>
        /// <param name="typesWithExpertise">A list of user-provided type-names and expertise levels. A Constraint type-name with its required expertise must be fulfill by the type-with-expertise Qualification to result in a violation free solution. (required).</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;TypeWithExpertise&quot;).</param>
        public TypeWithExpertiseQualification(List<TypeWithExpertise> typesWithExpertise = default, string typeName = @"TypeWithExpertise") : base()
        {
        ...
        /// <summary>
        /// A list of user-provided type-names and expertise levels. A Constraint type-name with its required expertise must be fulfill by the type-with-expertise Qualification to result in a violation free solution.
        /// </summary>
        /// <value>A list of user-provided type-names and expertise levels. A Constraint type-name with its required expertise must be fulfill by the type-with-expertise Qualification to result in a violation free solution.</value>
