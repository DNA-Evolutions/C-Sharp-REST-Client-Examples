...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunAcceptedResponse")]
    public partial class RunAcceptedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunAcceptedResponse" /> class.
        /// </summary>
        /// <param name="runId">Unique identifier for this run. Use with GET /api/v1/runs/{runId}/result to retrieve the result and GET /api/v1/runs/{runId}/stream/_* for live events..</param>
        /// <param name="submittedAt">Epoch-millisecond timestamp when the run was accepted..</param>
        /// <param name="ident">User-defined label echoed back from the input ident field..</param>
        public RunAcceptedResponse(string runId = default, long submittedAt = default, string ident = default)
        {
            this.RunId = runId;
        ...
        /// <summary>
        /// Unique identifier for this run. Use with GET /api/v1/runs/{runId}/result to retrieve the result and GET /api/v1/runs/{runId}/stream/_* for live events.
        /// </summary>
        /// <value>Unique identifier for this run. Use with GET /api/v1/runs/{runId}/result to retrieve the result and GET /api/v1/runs/{runId}/stream/_* for live events.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// Epoch-millisecond timestamp when the run was accepted.
        /// </summary>
        /// <value>Epoch-millisecond timestamp when the run was accepted.</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// User-defined label echoed back from the input ident field.
        /// </summary>
        /// <value>User-defined label echoed back from the input ident field.</value>
        /*
        <example>my-optimization-run</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RunAcceptedResponse {\n");
