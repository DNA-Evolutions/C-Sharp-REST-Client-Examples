...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LoadDimension : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="LoadDimension" /> class.
        /// </summary>
        /// <param name="unloadAllDimension">The number of load dimensions that participate in the unload-all operation. For example, if the resource carries goods across 3 dimensions (weight, volume, pallets) and unloadAllDimension is set to 2, only the first 2 dimensions are emptied at this node. (required).</param>
        /// <param name="totalLoadDimension">The total number of load dimensions defined for this node. Must match the dimensionality of the resource&#39;s capacity vector and the node&#39;s load vector. (required).</param>
        /// <param name="unloadAll">If true, the resource unloads all remaining cargo at this node before continuing. Typically used at depot-return nodes or redistribution hubs in PND scenarios..</param>
        public LoadDimension(int unloadAllDimension = default, int totalLoadDimension = default, bool unloadAll = default)
        {
        ...
        /// <summary>
        /// The number of load dimensions that participate in the unload-all operation. For example, if the resource carries goods across 3 dimensions (weight, volume, pallets) and unloadAllDimension is set to 2, only the first 2 dimensions are emptied at this node.
        /// </summary>
        /// <value>The number of load dimensions that participate in the unload-all operation. For example, if the resource carries goods across 3 dimensions (weight, volume, pallets) and unloadAllDimension is set to 2, only the first 2 dimensions are emptied at this node.</value>
        [DataMember(Name = "unloadAllDimension", IsRequired = true, EmitDefaultValue = true)]
        public int UnloadAllDimension { get; set; }

        /// <summary>
        /// The total number of load dimensions defined for this node. Must match the dimensionality of the resource&#39;s capacity vector and the node&#39;s load vector.
        /// </summary>
        /// <value>The total number of load dimensions defined for this node. Must match the dimensionality of the resource&#39;s capacity vector and the node&#39;s load vector.</value>
        [DataMember(Name = "totalLoadDimension", IsRequired = true, EmitDefaultValue = true)]
        public int TotalLoadDimension { get; set; }

        /// <summary>
        /// If true, the resource unloads all remaining cargo at this node before continuing. Typically used at depot-return nodes or redistribution hubs in PND scenarios.
        /// </summary>
        /// <value>If true, the resource unloads all remaining cargo at this node before continuing. Typically used at depot-return nodes or redistribution hubs in PND scenarios.</value>
