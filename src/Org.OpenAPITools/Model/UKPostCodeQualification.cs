...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UKPostCodeQualification : QualificationType, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="myExtraCodes">Additional UK postcodes this resource is also qualified to serve, beyond the primary code..</param>
        /// <param name="typeName">The typeName of the object (required) (default to &quot;UKPostCodeQualification&quot;).</param>
        public UKPostCodeQualification(ZoneCodeType myCode = default, List<ZoneCodeType> myExtraCodes = default, string typeName = @"UKPostCodeQualification") : base()
        {
        ...
        /// Gets or Sets MyCode
        /// </summary>
        [DataMember(Name = "myCode", IsRequired = true, EmitDefaultValue = true)]
        public ZoneCodeType MyCode { get; set; }

        /// <summary>
        /// Additional UK postcodes this resource is also qualified to serve, beyond the primary code.
        /// </summary>
        /// <value>Additional UK postcodes this resource is also qualified to serve, beyond the primary code.</value>
        ...
        /*
        <example>UKPostCodeQualification</example>
        */
