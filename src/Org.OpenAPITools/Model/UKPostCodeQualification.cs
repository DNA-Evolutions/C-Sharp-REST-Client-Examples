...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UKPostCodeQualification : QualificationType, IValidatableObject
    {
        ...
        public UKPostCodeQualification(ZoneCodeType myCode = default(ZoneCodeType), List<ZoneCodeType> myExtraCodes = default(List<ZoneCodeType>), string typeName = @"UKPostCodeQualification") : base()
        {
