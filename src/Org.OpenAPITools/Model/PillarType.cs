...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PillarType")]
    [JsonConverter(typeof(JsonSubtypes), "TypeName")]
    [JsonSubtypes.KnownSubType(typeof(EventPillarNode), "EventPillarNode")]
    [JsonSubtypes.KnownSubType(typeof(GeoPillarNode), "GeoPillarNode")]
    public partial class PillarType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PillarType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PillarType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PillarType" /> class.
        /// </summary>
        /// <param name="typeName">typeName (required).</param>
        public PillarType(string typeName = default)
        {
            // to ensure "typeName" is required (not null)
            if (typeName == null)
            {
                throw new ArgumentNullException("typeName is a required property for PillarType and cannot be null");
            }
