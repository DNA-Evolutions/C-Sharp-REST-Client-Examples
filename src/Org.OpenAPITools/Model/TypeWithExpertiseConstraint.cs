...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeWithExpertiseConstraint : ConstraintType, IValidatableObject
    {
        ...
        public TypeWithExpertiseConstraint(List<TypeWithExpertise> typesWithExpertise = default, CostModelEnum? costModel = default, string typeName = @"TypeWithExpertise") : base()
        {
