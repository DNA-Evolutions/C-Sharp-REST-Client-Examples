...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeConstraint : ConstraintType, IEquatable<TypeConstraint>, IValidatableObject
    {
        /// <summary>
        ...
        public TypeConstraint(List<string> typeNames = default(List<string>), string typeName = "Type") : base()
        {
        ...
        {
            return this.Equals(input as TypeConstraint);
        }

        /// <summary>
        /// Returns true if TypeConstraint instances are equal
        /// </summary>
        /// <param name="input">Instance of TypeConstraint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeConstraint input)
        {
            if (input == null)
            {
                return false;
