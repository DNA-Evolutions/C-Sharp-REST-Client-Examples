...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DayMonth : DateDef, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="typeName">typeName (required) (default to &quot;DayMonth&quot;).</param>
        public DayMonth(int month = default, int day = default, string typeName = @"DayMonth") : base(typeName)
        {
            this.Month = month;
            this.Day = day;
        }
