...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SecurityHelperItemMetadata : IValidatableObject
    {
        ...
        public SecurityHelperItemMetadata(string iv = default, string salt = default, string encAlgo = default, string secretKeyFacAlgo = default, string secretKeySpecAlgo = default)
        {
