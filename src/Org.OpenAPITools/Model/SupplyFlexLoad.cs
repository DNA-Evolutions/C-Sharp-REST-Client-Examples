...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplyFlexLoad : ILoad, IValidatableObject
    {
        ...
        public SupplyFlexLoad(string loadId = default, bool isRequest = default, bool isFuzzyVisit = default, string typeName = @"SupplyFlexLoad", int priority = default, bool fuzzyVisit = default, double loadValue = default, bool request = default, string id = default) : base(priority, fuzzyVisit, loadValue, request, id)
        {
