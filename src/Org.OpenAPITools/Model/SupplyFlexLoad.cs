...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplyFlexLoad : ILoad, IEquatable<SupplyFlexLoad>, IValidatableObject
    {
        ...
        public SupplyFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "SupplyFlexLoad", int priority = default(int), bool fuzzyVisit = default(bool), double loadValue = default(double), bool request = default(bool), string id = default(string)) : base(priority, fuzzyVisit, loadValue, request, id)
        {
