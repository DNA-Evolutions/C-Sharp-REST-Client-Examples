...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplyFlexLoad : ILoad, IEquatable<SupplyFlexLoad>, IValidatableObject
    {
        /// <summary>
        ...
        public SupplyFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = "SupplyFlexLoad", int priority = default(int), bool fuzzyVisit = default(bool), bool request = default(bool), double loadValue = default(double), string id = default(string)) : base(priority, fuzzyVisit, request, loadValue, id)
        {
        ...
        {
            return this.Equals(input as SupplyFlexLoad);
        }

        /// <summary>
        /// Returns true if SupplyFlexLoad instances are equal
        /// </summary>
        /// <param name="input">Instance of SupplyFlexLoad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupplyFlexLoad input)
        {
            if (input == null)
            {
                return false;
