...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplyFlexLoad : ILoad, IValidatableObject
    {
        ...
        public SupplyFlexLoad(string loadId = default(string), bool isRequest = default(bool), bool isFuzzyVisit = default(bool), string typeName = @"SupplyFlexLoad", int priority = default(int), bool request = default(bool), double loadValue = default(double), bool fuzzyVisit = default(bool), string id = default(string)) : base(priority, request, loadValue, fuzzyVisit, id)
        {
