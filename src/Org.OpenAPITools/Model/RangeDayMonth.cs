...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RangeDayMonth")]
    public partial class RangeDayMonth : DateDef, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeDayMonth" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RangeDayMonth() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeDayMonth" /> class.
        /// </summary>
        /// <param name="from">from.</param>
        /// <param name="to">to.</param>
        /// <param name="typeName">typeName (required) (default to &quot;RangeDayMonth&quot;).</param>
        public RangeDayMonth(DayMonth from = default, DayMonth to = default, string typeName = @"RangeDayMonth") : base(typeName)
        {
            this.From = from;
            this.To = to;
        }
        ...
        public DayMonth From { get; set; }

        /// <summary>
        /// Gets or Sets To
        /// </summary>
        [DataMember(Name = "to", EmitDefaultValue = false)]
        public DayMonth To { get; set; }
