...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NodeColor : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="NodeColor" /> class.
        /// </summary>
        /// <param name="colorCode">A numeric color code identifying this color category. Must match the codes used in NodeColorCapacity constraints. (required).</param>
        /// <param name="colorId">A human-readable identifier for this color category (e.g. &#39;HAZARDOUS&#39;, &#39;PRIORITY_A&#39;, &#39;COLD_CHAIN&#39;). (required).</param>
        /// <param name="countValue">The contribution count of this node towards its color category. Defaults to 1. A higher value means this node &#39;consumes&#39; more of the route&#39;s color capacity budget..</param>
        public NodeColor(int colorCode = default, string colorId = default, int countValue = default)
        {
        ...
        /// <summary>
        /// A numeric color code identifying this color category. Must match the codes used in NodeColorCapacity constraints.
        /// </summary>
        /// <value>A numeric color code identifying this color category. Must match the codes used in NodeColorCapacity constraints.</value>
        [DataMember(Name = "colorCode", IsRequired = true, EmitDefaultValue = true)]
        public int ColorCode { get; set; }

        /// <summary>
        /// A human-readable identifier for this color category (e.g. &#39;HAZARDOUS&#39;, &#39;PRIORITY_A&#39;, &#39;COLD_CHAIN&#39;).
        /// </summary>
        /// <value>A human-readable identifier for this color category (e.g. &#39;HAZARDOUS&#39;, &#39;PRIORITY_A&#39;, &#39;COLD_CHAIN&#39;).</value>
        [DataMember(Name = "colorId", IsRequired = true, EmitDefaultValue = true)]
        public string ColorId { get; set; }

        /// <summary>
        /// The contribution count of this node towards its color category. Defaults to 1. A higher value means this node &#39;consumes&#39; more of the route&#39;s color capacity budget.
        /// </summary>
        /// <value>The contribution count of this node towards its color category. Defaults to 1. A higher value means this node &#39;consumes&#39; more of the route&#39;s color capacity budget.</value>
