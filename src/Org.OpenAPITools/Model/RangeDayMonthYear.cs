...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RangeDayMonthYear")]
    public partial class RangeDayMonthYear : DateDef, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeDayMonthYear" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RangeDayMonthYear() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeDayMonthYear" /> class.
        /// </summary>
        /// <param name="from">from.</param>
        /// <param name="to">to.</param>
        /// <param name="typeName">typeName (required) (default to &quot;RangeDayMonthYear&quot;).</param>
        public RangeDayMonthYear(DayMonthYear from = default, DayMonthYear to = default, string typeName = @"RangeDayMonthYear") : base(typeName)
        {
            this.From = from;
            this.To = to;
        }
        ...
        public DayMonthYear From { get; set; }

        /// <summary>
        /// Gets or Sets To
        /// </summary>
        [DataMember(Name = "to", EmitDefaultValue = false)]
        public DayMonthYear To { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RangeDayMonthYear {\n");
