...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TypeLevelRequirement")]
    public partial class TypeLevelRequirement : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeLevelRequirement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TypeLevelRequirement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeLevelRequirement" /> class.
        /// </summary>
        ...
        public TypeLevelRequirement(int level = default, bool isMin = default)
        {
            this.Level = level;
            this.IsMin = isMin;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TypeLevelRequirement {\n");
