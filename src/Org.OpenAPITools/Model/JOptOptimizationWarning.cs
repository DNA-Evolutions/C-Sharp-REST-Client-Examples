...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationWarning : IEquatable<JOptOptimizationWarning>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as JOptOptimizationWarning);
        }

        /// <summary>
        /// Returns true if JOptOptimizationWarning instances are equal
        /// </summary>
        /// <param name="input">Instance of JOptOptimizationWarning to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JOptOptimizationWarning input)
        {
            if (input == null)
            {
                return false;
