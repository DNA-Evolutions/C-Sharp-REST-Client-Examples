...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationWarning : IValidatableObject
    {
        ...
        public JOptOptimizationWarning(string creator = default, string jobId = default, string tenantId = default, string ident = default, string message = default, int code = default, string desc = default, DateTime expireAt = default)
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for JOptOptimizationWarning and cannot be null");
            }
            this.JobId = jobId;
            // to ensure "tenantId" is required (not null)
            if (tenantId == null)
            {
                throw new ArgumentNullException("tenantId is a required property for JOptOptimizationWarning and cannot be null");
            }
