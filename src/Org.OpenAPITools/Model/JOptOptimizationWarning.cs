...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class JOptOptimizationWarning : IValidatableObject
    {
        ...
        public JOptOptimizationWarning(string creator = default, string ident = default, string message = default, int code = default, string desc = default, DateTime expireAt = default)
        {
